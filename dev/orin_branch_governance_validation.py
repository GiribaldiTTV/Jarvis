...
FAM006_H1_REQUIRED_PHRASES = (
    ...
    "WS50 Scrollbar / Native Window Boundary Pressure-Test:",
    "one rounded native window boundary",
    "square translucent outer haze is gone",
    "WS50 Focused Visual Evidence:",
    "h1_ws50_dashboard_right_boundary_crop.png",
    "h1_ws50_dashboard_top_right_crop.png",
    "h1_after_resize_dashboard_right_boundary_crop.png",
    "Overlay Classification:",
    "deferred/non-gating",
    "Core Classification:",
    "dependency-only",
    ...
    "PASS - dev/orin_monitoring_hud_surface_validation.py",
    "Internal Sandbox Proof:",
    "20260510_173034_manifest.json",
    "Desktop Entrypoint / Startup / Tray Proof:",
    "DesktopEntrypointValidationReport_20260510_173744.txt",
    "Human-Client Proof:",
    "20260510_173755_365/human_client_manifest.json",
    "Live Helper Proof:",
    "20260510_174014_559/manifest.json",
    "Screenshot Proof Root:",
    "20260510_174014_559",
    "USER-Inspectable Screenshot Folder:",
    "Package Status:",
