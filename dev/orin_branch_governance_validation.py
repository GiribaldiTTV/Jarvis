...
FAM006_ELEMENT_LEDGER_REQUIRED_PHRASES = (
    ...
    "Ledger Status: `Backfilled, revalidated, USER feedback disposition repaired, and LV1 handoff refreshed - Live Validation Stage 1`",
    ...
    "## UTS Coverage Map",
    "Current Coverage Status: `LV1 refreshed UTS handoff generated / USER result pending`",
    "Workstream WS37 - Dashboard Runtime Window Tray Safety And NCP Regression Isolation",
