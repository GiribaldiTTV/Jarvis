...
FAM006_ELEMENT_LEDGER_REQUIRED_PHRASES = (
    ...
    "## UTS Coverage Map",
    "Current Coverage Status: `Live Validation LV1 Handoff Green - RUI-001 through RUI-047 are issue-grounded in the refreshed UTS; returned USER results pending`",
