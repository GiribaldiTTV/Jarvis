...
FAM006_ELEMENT_LEDGER_REQUIRED_PHRASES = (
    ...
    "## UTS Coverage Map",
    "Current Coverage Status: `Hardening H1 Green After WS53 / Refreshed LV1 Required - RUI-001 through RUI-052 remain issue-grounded; latest returned feedback reopened Dashboard resize edge discoverability after WS52, WS53 repaired it, H1 pressure-tested it, and LV2 remains blocked`",
