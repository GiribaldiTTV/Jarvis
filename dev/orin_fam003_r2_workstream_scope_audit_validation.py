...
FILE_METADATA: dict[str, dict[str, Any]] = {
    ...
    "dev/fam003_renderer_backend_runtime_probe.py": _meta(
        ...
        "Environment-gated probe exercises and captures ORIN Core, HUD Dashboard, Recording Suite, Log Viewer, and AI Status / Command Center; records three sustained startup-idle, representative-active, and post-use-idle samples with per-process attribution and truthful event timing; verifies deferred AI domains remain disabled; and requests normal shutdown.",
        "Slice E / SLC-R2-009,010 / R2-WS09,10 renderer-backend completion proof.",
        ...
        "Three normal-launcher sessions, 5-second settle plus 10-second raw samples, PNG/nonblank checks, DOM/action checks outside timed intervals, preserved-current lifecycle report, and aggregate consumption.",
    ...
    "dev/orin_fam003_renderer_backend_workstream_validation.py": _meta(
        ...
        "Inventories eight WebEngine rows, blocks foreign runtimes, resolves the exact Desktop shortcut, runs three normal-launcher sessions, consumes current lifecycle proof, validates sustained raw performance and process attribution, refuses unsupported equivalence without a safe baseline, records rollback/scope/defect receipts, and enforces 39 negative fixtures.",
        "Slice E / SLC-R2-009,010 / R2-WS09,10 renderer-backend completion proof.",
