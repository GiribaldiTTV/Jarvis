    ...
    crop_specs = dict(
        [
            ...
            spec_from_dom(
                ...
                excluded_reason="The parent action strip aggregate text includes OPEN LOG VIEWER, and the compact crop may include the adjacent state-row underglow boundary; the transport pill proof excludes those declared adjacent/context strings and relies on child segment text plus route-edge geometry to prove separation.",
                excluded_dom_keys=[
                    "recordingActionStrip",
                    "recordingLogRoute",
                    "recordingTruthStrip",
                    "recordingTargetTruth",
                    "recordingStateTruth",
                ],
                adjacent_allowed=True,
                adjacent_reason="The accepted compact Recording Suite footprint places the transport pill immediately below the state row; a thin adjacent state-row boundary may be present as context but is not part of the target relationship proof.",
                min_width=170,
                min_height=30,
                margin=8,
            ),
            ...
            spec_from_dom(
                ...
                adjacent_allowed=True,
                adjacent_reason="The accepted compact Recording Suite action row sits immediately below the state row; a thin adjacent state-row boundary may be present as context but the element proof remains the OPEN LOG VIEWER route.",
                min_width=180,
                min_height=30,
                margin=8,
            ),
            ...
            spec_from_dom(
                ...
                excluded_reason="Compact doorway-state proof may include nearby title/control geometry and a thin action-row boundary because the VIEWER row sits between both groups in the accepted compact shell.",
            ...
            spec_from_dom(
                ...
                adjacent_allowed=True,
                adjacent_reason="The accepted compact Log Viewer action row sits immediately below the VIEWER state row; a thin adjacent state-row boundary may be present as context but the element proof remains the native logs action.",
                min_width=160,
                min_height=30,
                margin=8,
            ),
            spec_from_dom(
                ...
                adjacent_allowed=True,
                adjacent_reason="The accepted compact Log Viewer action row sits immediately below the VIEWER state row; a thin adjacent state-row boundary may be present as context but the element proof remains the exported logs action.",
                min_width=180,
                min_height=30,
                margin=8,
            ),
