    ...
    crop_specs = dict(
        [
            ...
            spec_from_dom(
                ...
                expected=["NATIVE", "Recordings folder"],
                forbidden_adjacent=["EXPORT", "Exported Logs folder", "Open Exported Logs", "Available now", "Empty until exported"],
                adjacent_allowed=True,
                adjacent_reason="Compact AI Control Center / HUD state-row rhythm allows the neighboring destination row divider geometry inside the required 8px context margin; the separate log-viewer-action-status crop proves the native/export relationship.",
                min_width=340,
                min_height=20,
                margin=8,
            ),
            spec_from_dom(
                ...
                expected=["EXPORT", "Exported Logs folder"],
                forbidden_adjacent=["NATIVE", "Recordings folder", "Open Native Logs", "Available now", "Empty until exported"],
                adjacent_allowed=True,
                adjacent_reason="Compact AI Control Center / HUD state-row rhythm allows the neighboring destination row divider geometry inside the required 8px context margin; the separate log-viewer-action-status crop proves the native/export relationship.",
                min_width=340,
                min_height=20,
