...
def _write_ufd_record(root: Path, text_override: str | None = None) -> Path:
    ...
    text = text_override or (
        ...
        "Accepted BP2 Acceptance Receipt: `decision2_option_g_bp2_acceptance_20260724.md`\n"
         ...
         "## Current Revised BP1 Route Contract\n\n"
         "Selected Implementation Route: `Implement the admitted FAM-003 resident access package after later BP2/BP3/Workstream approval.`\n"
         "Implementation Route Class: `Implementation-bearing FAM-003 package; BP1 itself delivers no runtime mutation.`\n"
         "Concrete Deliverable: `A later-gated user-facing resident-access package.`\n"
         "Implementation Output: `Later accepted gates must implement and prove the admitted route; current BP1 returns only the revised vision.`\n"
         "Infrastructure / Setup Relationship: `Packet and validator work are review-enabling support; no runtime/UI implementation is authorized here.`\n"
         "USER Action Gate: `USER must accept the current BP1 vision before later planning or implementation gates.`\n"
         "Route Disposition: `CONTINUE_ONLY_AFTER_BP1_USER_ACCEPTANCE`\n"
         "Retarget / Rename Recommendation: `Keep the current FAM-003 carrier; no retarget or split.`\n"
         "Concrete USER-Facing Feature Classification: `Concrete USER-facing feature / planned later-gated outcome.`\n\n"
