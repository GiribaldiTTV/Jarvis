# Invalid Rebaseline Adoption Repo Live-State Tracking Fixture
...
No Repo Live-State Tracking: active RAR rows are tracked in repo docs and mirrored in C:\Nexus Governance State for convenience.
