# Valid Rebaseline Adoption Direct Negated Green Fixture

RAR Stage: RAR2 Adoption Ledger Generation before repair closeout.
...
Affected Proof Claims: branch explicitly says unresolved rows are not adoption green.
Merged Standard Comparison Result: one NONCONFORMING HUD row remains and no green claim is made.
...
Visual Element / Element-Group Inspection Ledger: one HUD close-control row remains NONCONFORMING.
...
Owned-Surface Nonconformance Ledger: HUD Dashboard close control remains NONCONFORMING against UIREF-002.
Current Branch Repair Candidates: HUD close-control repair remains open.
...
Adoption Disposition: not adoption green with evidence until the remaining nonconformance is repaired.
Repair / Waiver / Blocker: active repair blocker remains recorded.
Validation Summary: validator output confirms the RAR gate is not all adoption checks are green.
...
Next Legal Phase: RAR2 evidence repair remains active until the nonconforming HUD close-control row is repaired or explicitly routed.
Exact Next USER Decision: no USER decision needed in this valid fixture.
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| HUD Dashboard | Window control cluster | desktop/desktop_renderer.py HUD close region | FAM-006 desktop renderer | focused screenshot packet | UIREF-002 and AI Control Center seed | Mismatch | Unproven | NONCONFORMING | large CLOSE control remains | Repair before green |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| Window control cluster | Accepted Reference | UIREF-002 and FAM-002 | compact placement and Nexus glow | labels may differ | HUD Dashboard | Reference-Derived | screenshot | NONCONFORMING |
