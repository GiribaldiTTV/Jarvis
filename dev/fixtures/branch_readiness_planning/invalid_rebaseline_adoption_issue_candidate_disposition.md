# Invalid Rebaseline Adoption Issue Candidate Disposition Fixture

RAR Stage: RAR3 USER Review Gate - issue candidates require disposition before continuation.
...
Affected File Inventory: desktop/desktop_renderer.py and FAM-006 validation helper surfaces are affected branch-local files.
...
Merged Standard Comparison Result: current studio controls require reference-derived parity proof; historical HUD close treatment becomes a mixed-case issue candidate.
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| Window control cluster | Accepted Reference | UIREF-002 and FAM-002 | compact placement and Nexus glow | labels may differ | HUD Dashboard | Reference-Derived | screenshot | mixed-case issue candidate |
...
| --- | --- | --- | --- |
| Missing | This fixture omits USER review disposition | Nothing | GitHub issue mutation |
