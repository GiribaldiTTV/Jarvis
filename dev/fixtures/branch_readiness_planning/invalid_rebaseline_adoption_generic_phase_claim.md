# Invalid Rebaseline Adoption Generic Phase Claim Fixture

RAR Stage: RAR3 USER Review Gate remains active before normal phase continuation.
...
Incoming Standard / Change Summary: merged standards require USER review before normal phase progression.
...
Affected Proof Claims: branch tries to resume normal phase progression while RAR review remains active.
...
Adoption Disposition: normal phase progression after local validation even though RAR USER Review Gate remains active.
Repair / Waiver / Blocker: RAR USER Review Gate remains active until USER reviews issue candidates.
Validation Summary: fixture validation should fail because normal phase progression is claimed while RAR remains active.
