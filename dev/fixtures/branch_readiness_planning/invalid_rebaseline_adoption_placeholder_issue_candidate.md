# Invalid Rebaseline Adoption Placeholder Issue Candidate Fixture
...
Issue-Candidate Table: placeholder row below is not enough for USER review.
...
Validation Summary: fixture validation should fail because the issue-candidate row is placeholder data.
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| TBD | FAM-006 | TBD | TBD | TBD | TBD | TBD | No |

| RAR USER Decision | Meaning | What It Authorizes | What It Does Not Authorize |
| --- | --- | --- | --- |
| Review issue candidate | Placeholder candidate cannot be reviewed | Nothing | GitHub issue mutation |
