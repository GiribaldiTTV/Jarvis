# Invalid Rebaseline Adoption Prefixed No Candidate Prose Fixture
...
Affected Proof Claims: branch hides a historical candidate after no-candidate prefix wording.
Merged Standard Comparison Result: the previous-candidate marker names an issue candidate that is not tabled.
...
Visual Element / Element-Group Inspection Ledger: one HUD close-control row remains an issue candidate.
...
Current Branch Repair Candidates: no runtime repair is authorized before issue-candidate disposition.
Previous / Historical Branch Issue Candidates: none recorded yet for Issue Candidate F6-HIST-001 pending review.
...
Adoption Disposition: RAR remains active and is not closed.
Repair / Waiver / Blocker: previous issue candidate is hidden by invalid no-candidate prose.
Validation Summary: fixture validation should fail because no-candidate wording names a concrete candidate.
...
| --- | --- | --- | --- |
| None | No decision needed | Nothing | Runtime mutation |
