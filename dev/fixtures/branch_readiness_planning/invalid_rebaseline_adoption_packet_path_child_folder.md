# Invalid Rebaseline Adoption Packet Path Child Folder Fixture
...
Merged Standard Comparison Result: RAR review packet path must point to the packet root folder, not a child folder.
...
USER Packet Path: C:\Nexus USER\FAM-006\Review Aids contains a child review-aids folder, not the packet root.
