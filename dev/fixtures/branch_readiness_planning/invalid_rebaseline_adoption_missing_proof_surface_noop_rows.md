# Invalid Rebaseline Adoption Missing Proof Surface No-Op Rows Fixture
...
Affected Proof Claims: active review names real surfaces with missing proof but supplies no substantive code-to-visual evidence row.
...
Accepted Reference / Template / Primitive Comparator Matrix: table below is invalid because it supplies no substantive comparator row for the affected surfaces.
...
Screenshot / Video / Contact-Sheet Evidence: screenshot/contact-sheet proof path is named in the USER packet; proof gaps are explicit for active studio surfaces.
Visual Element / Element-Group Inspection Ledger: active affected surfaces are named but no substantive trace row is recorded.
