# Invalid Rebaseline Adoption Missing Code Trace Fixture

RAR Stage: RAR2 Adoption Ledger Generation with USER packet preparation.
...
Current Branch Implementation Inventory: current branch touched studio controls and visible user-facing windows.
...
Implemented / Touched UI-UX Surfaces: studio controls, status rows, and folder action buttons.
Implemented / Touched Runtime-Backend Surfaces: local recording state and folder-open result text.
Affected Proof Claims: branch claims current UI complies with merged UIREF standards.
Merged Standard Comparison Result: comparison claimed complete without code-to-visual table.
...
Visual Element / Element-Group Inspection Ledger: all listed surfaces are summarized without trace rows.
...
Owned-Surface Nonconformance Ledger: no current defects claimed in this fixture.
...
Validation Summary: fixture validation should fail because code-to-visual trace table is missing.
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| Window control cluster | Accepted Reference | UIREF-002 and FAM-002 | compact placement and Nexus glow | labels may differ | Studio windows | Reference-Derived | screenshot | Missing code trace |
