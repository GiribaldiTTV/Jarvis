# Invalid BP1 Process Mechanics Review Fixture
...
Why This Fits The Nexus Vision: The fixture claims Nexus fit by keeping project and family vision above seams, helpers, validators, and Workstream implementation.
USER Design Questions: For this branch, what exact outcome should USER expect to see, inspect, or rely on? Which option above best matches the desired direction?
...
Design Assumption Ledger: Branch vision acceptance is required before BP2, and copied source truth remains supporting context only.
