# Invalid Rebaseline Adoption Go-To Phase Advance Fixture
...
Affected Proof Claims: branch tries to go to PR Readiness while RAR review remains active.
...
Validation Summary: fixture validation should fail because an affirmative go-to phase move is mixed with active RAR wording.
...
Exact Next USER Decision: RAR USER Review Gate remains active, but the branch can now go to PR Readiness.
