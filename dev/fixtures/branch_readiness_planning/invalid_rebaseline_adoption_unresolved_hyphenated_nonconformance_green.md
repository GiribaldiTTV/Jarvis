# Invalid Rebaseline Adoption Hyphenated Nonconformance Claimed Green Fixture
...
Affected Proof Claims: branch claims all visible UI is green after one repair.
Merged Standard Comparison Result: one NON-CONFORMING HUD row remains but disposition claims green.
...
Visual Element / Element-Group Inspection Ledger: one HUD close-control row remains NON-CONFORMING.
...
Owned-Surface Nonconformance Ledger: HUD Dashboard close control remains NON-CONFORMING against UIREF-002.
...
Current Violation Findings: HUD top-level close control is NON-CONFORMING.
...
Validation Summary: fixture validation should fail because unresolved hyphenated nonconformance is claimed green.
...
Next Legal Phase: repair unresolved RAR nonconformance before normal phase continuation.
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| HUD Dashboard | Window control cluster | desktop/desktop_renderer.py HUD close region | FAM-006 desktop renderer | focused screenshot packet | UIREF-002 and AI Control Center seed | Mismatch | Unproven | NON-CONFORMING | large CLOSE control remains | Repair before green |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| Window control cluster | Accepted Reference | UIREF-002 and FAM-002 | compact placement and Nexus glow | labels may differ | HUD Dashboard | Reference-Derived | screenshot | NON-CONFORMING |
