# Invalid Rebaseline Adoption No-Op Active Rows Fixture
...
Affected Proof Claims: active review names real surfaces but supplies no substantive code-to-visual evidence row.
