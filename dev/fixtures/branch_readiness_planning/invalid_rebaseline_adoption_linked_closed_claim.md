# Invalid Rebaseline Adoption Linked Closed Claim Fixture
...
Affected Proof Claims: branch claims RAR is closed despite one unresolved row.
Merged Standard Comparison Result: one NONCONFORMING HUD row remains but disposition says closure.
...
Adoption Disposition: RAR is closed after evidence review.
Repair / Waiver / Blocker: no blocker recorded.
Validation Summary: fixture validation should fail because linked closure is claimed over unresolved nonconformance.
