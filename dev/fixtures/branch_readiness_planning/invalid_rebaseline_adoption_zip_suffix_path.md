# Invalid Rebaseline Adoption ZIP Suffix Path Fixture
...
Incoming Standard / Change Summary: merged standards require deterministic USER packet ZIP proof.
...
USER Packet ZIP Path: C:\Nexus USER\FAM-006-20260620-120000.zip.tmp.
