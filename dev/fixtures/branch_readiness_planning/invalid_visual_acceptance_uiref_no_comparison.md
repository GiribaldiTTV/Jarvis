# Invalid Visual Acceptance UIREF No Comparison Fixture

Material Visible Change Classification: Material visible UI is in scope for an AI diagnostics child window.

Visual Acceptance Target Plan: Visual Acceptance Target is defined before Workstream from UIREF-001 and UIREF-002.
...
Accepted Reference Set / Comparative Synthesis: UIREF citation alone is sufficient for this branch packet.

Visual Family Relation Proof: Reference cited but not compared because the packet names UIREF-001 and UIREF-002.
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| AI diagnostics child window | Detached child diagnostics surface | Reference-Derived Implementation | UIREF-001 and UIREF-002 | Window frame | NDAI frame and glow | Diagnostics content | Focused screenshot set | Match planned | Match planned | CONFORMING WHEN PROVEN | Continue after proof |
...
| --- | --- | --- | --- | --- |
| BP2/BP3 | Element comparison | UIREF citation alone | Accepted Reference Not Compared | Yes |
