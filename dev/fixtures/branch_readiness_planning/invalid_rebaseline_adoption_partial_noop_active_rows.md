# Invalid Rebaseline Adoption Partial No-Op Active Rows Fixture
...
Affected Proof Claims: active review names real surfaces but leaves trace/evidence/comparator columns as no-op values.
...
Accepted Reference / Template / Primitive Comparator Matrix: table below is invalid because most comparator fields are no-op.
...
Visual Element / Element-Group Inspection Ledger: active affected surfaces are named but partial no-op rows avoid real trace proof.
...
Owned-Surface Nonconformance Ledger: current branch rows are not actually proven because no substantive evidence table row exists.
...
Exact Next USER Decision: USER reviews RAR issue candidates; normal phase progression is not authorized.
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| HUD Dashboard | N/A | Not Applicable With Reason | None | Not Applicable With Reason | Not Applicable With Reason | Not Applicable With Reason | Not Applicable With Reason | CONFORMING | None | Continue |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| Window control cluster | Not Applicable With Reason | Not Applicable With Reason | None | None | None | Not Applicable With Reason | validation summary | No issue candidate applicable |
