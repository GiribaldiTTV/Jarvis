...
def validate() -> list[str]:
    ...
    for needle in (
        ...
        "WINDOW_CONTROL_CHROME_PADDING = 12",
        "WINDOW_CONTROL_TITLE_CARD_GUTTER = 15",
        "WINDOW_CONTROL_ZONE_TOP = WINDOW_CONTROL_CHROME_PADDING + WINDOW_CONTROL_TITLE_CARD_GUTTER",
        "WINDOW_CONTROL_ZONE_RIGHT = WINDOW_CONTROL_CHROME_PADDING + WINDOW_CONTROL_TITLE_CARD_GUTTER",
    ...
    for needle in (
        ...
        'data-default-window-width="720"',
        'data-default-window-height="640"',
        ...
        "--ai-dashboard-title-card-window-control-gutter: 15px",
        "top: calc(var(--ai-dashboard-chrome-padding) + var(--ai-dashboard-title-card-window-control-gutter))",
        "right: calc(var(--ai-dashboard-chrome-padding) + var(--ai-dashboard-title-card-window-control-gutter))",
        "--ai-dashboard-row-gutter: 8px",
        "--ai-dashboard-row-label-width: max-content",
        "--ai-dashboard-row-label-column-contract: measured-max-visible-label-content",
        "grid-template-columns: var(--ai-dashboard-row-label-width, max-content) minmax(0, 1fr)",
