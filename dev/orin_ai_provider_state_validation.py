...
def validate() -> list[str]:
    ...
    for needle in (
        ...
        'data-window-boundary-contract="visible-native-interactive-coincident-v1"',
        'data-window-move="windows-native-caption-hit-test-with-webview-fallback"',
        'data-window-resize="windows-native-edge-corner-hit-test-with-webview-fallback"',
        'data-window-default-geometry-contract="dom-content-measured-screen-bounded-v1"',
