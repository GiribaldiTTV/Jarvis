...
def validate() -> list[str]:
    ...
    for needle in (
        ...
        'data-default-window-width="840"',
        'data-default-window-height="900"',
        'data-default-window-max-height="900"',
        ...
        'data-settings-route="fam003-global-settings-ai-future-gated-no-fam003-mutation"',
        ...
        "Blocked; no provider/model path active",
        "None leaves this machine",
