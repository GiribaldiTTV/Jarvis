...
def validate() -> list[str]:
    ...
    for needle in (
        ...
        'data-single-action-button-model="content-fit-fixed-height-no-ellipsis"',
        ...
        'data-dashboard-ia-model="ai-dashboard-parent-global-strip-category-cards-detached-domain-windows-active"',
        ...
        'data-category-card-launcher-contract="cards-open-ndai-domain-windows-no-inline-workspace-actions"',
        'data-child-window-model="detached-domain-window-route-lifecycle-active"',
        ...
        'data-launch-target="control-center"',
        'data-launch-target="readiness-diagnostics"',
        'data-launch-target="capabilities-maintenance"',
        'data-launch-window-kind="exclusive-child"',
        'data-launch-window-kind="external-unique"',
        'data-target-window-classification="exclusive-child"',
        'data-target-window-classification="external-unique"',
        'data-target-window-lifecycle="closes-with-dashboard"',
        'data-target-window-lifecycle="stays-open-if-dashboard-closes"',
        'data-window-lifecycle="closes-with-dashboard"',
        'data-window-lifecycle="stays-open-if-dashboard-closes"',
    ...
    for needle in (
        ...
        'data-window-boundary-contract="single-rounded-shell-mask-hit-rails-coincident-v2"',
        'data-window-boundary-inset="0"',
        'data-window-resize-rail-location="inside-visible-rounded-shell"',
        'data-window-outside-hit-behavior="noninteractive"',
        'data-window-move="measured-visible-title-strip-native-and-fallback-v2"',
        'data-window-description-drag="client-content-never-caption"',
        'data-window-resize="windows-native-edge-corner-hit-test-with-webview-fallback"',
        'data-window-default-geometry-contract="settled-dom-content-measured-screen-bounded-v2"',
        'data-window-supported-geometry-contract="minimum-default-intermediate-useful-large-screen-bounded"',
        'data-window-maximize-fullscreen-policy="not-offered-compact-detached-window"',
        'data-window-shell-visual-contract="single-border-no-outer-halo"',
    ...
    for needle in (
        ...
        '"focusedGovernedVisibleInputMatrix"',
        ...
        "controlCenterOperationalContract",
        "ai-control-center-local-boundary-control-v1",
        "capabilitiesBoundaryContract",
        "capabilities-maintenance-developer-owner-boundary-v1",
        "capabilitiesMaintenanceWorkflowContract",
        "capabilities-maintenance-display-workflow-v1",
        "_exercise_control_center_child_window",
        "_exercise_capabilities_child_window",
    ...
    for forbidden in (
        ...
        _require(
            ...
            f"AI Dashboard live active-domain helper must not use branch-era AI Control Center proof as accepted comparator: {forbidden!r}",
            failures,
        )
