...
def validate() -> list[str]:
    ...
    for needle in (
        ...
        'data-category-launcher="ai-control-center"',
        'data-category-launcher="ai-readiness-diagnostics"',
        ...
        'data-domain-surface="ai-control-center"',
        'data-domain-surface="ai-readiness-diagnostics"',
        'data-domain-surface="capabilities-maintenance"',
        'data-update-execution="blocked"',
        'data-download-execution="blocked"',
        'data-install-execution="blocked"',
        'data-focused-surface="local-ai-readiness-report"',
