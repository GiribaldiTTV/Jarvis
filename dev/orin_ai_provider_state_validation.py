...
def validate() -> list[str]:
    ...
    for needle in (
        ...
        'data-dashboard-card-order="orin-status-ai-persona-ai-diagnostics-ai-readiness-ai-trust-capability-dev-owner"',
        'data-dashboard-ia-model="ai-home-control-foyer-category-doorways-focused-readiness-detail"',
        'data-dashboard-hub-group="ai-home-control-foyer"',
