...
def validate_static_wiring(failures: list[str]):
    ...
    for token in (
        ...
        "windowResizeBehavior\", \"frameless-top-level-native-edge-corner-hit-test-app-owned-fallback-14px-no-visible-grip-splitter-minimum-640x318-maximum-1100x720-v23",
    ...
    for token in (
        ...
        "normal desktop shortcut launch plus SetCursorPos held Win32 left-button drag",
    ):
