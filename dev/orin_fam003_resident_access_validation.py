...
def validate_static_wiring(failures: list[str]):
    ...
    for token in (
        ...
        "settingsInformationArchitecture\", \"global-settings-shell-nexus-tray-quick-access-page",
        "settingsVisualRepair\", \"architecture-first-reference-conformance-v3",
        "referenceDerivedHeader\", \"ai-control-center-reference-derived-settings-shell-v3",
        ...
        "(\"MENU BUDGET\", f\"{MAX_QUICK_SLOT_COUNT} SLOTS\")",
        ...
        "residentAccessSettingsSummaryPanel",
        ...
        "Top-to-bottom order is the tray submenu order.",
