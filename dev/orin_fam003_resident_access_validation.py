...
def validate_static_wiring(failures: list[str]):
    ...
    for token in (
        ...
        "windowResizeBehavior\", \"frameless-top-level-hover-polled-edge-corner-cursor-app-owned-fallback-16px-no-visible-grip-splitter-minimum-560x286-maximum-1100x720-v24",
