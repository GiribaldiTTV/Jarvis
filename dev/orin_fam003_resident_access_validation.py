...
def validate_static_wiring(failures: list[str]):
    ...
    for token in (
        ...
        "setMinimumSize(*self.MINIMUM_SIZE)",
        ...
        "windowResizeBehavior\", \"frameless-top-level-hover-polled-edge-corner-cursor-app-owned-fallback-8px-edge-12px-corner-no-visible-grip-splitter-minimum-560x286-maximum-1100x720-v25",
        ...
        "up_button.setFixedSize(20, 19)",
        "delete_button.setFixedSize(24, 19)",
