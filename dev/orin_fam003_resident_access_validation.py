...
def validate_static_wiring(failures: list[str]):
    ...
    for token in (
        ...
        "setMinimumSize(640, 318)",
        "setMaximumSize(760, 384)",
        ...
        "windowResizeBehavior\", \"frameless-top-level-native-edge-corner-hit-test-14px-no-visible-grip-splitter-minimum-640x318-maximum-760x384-v22",
