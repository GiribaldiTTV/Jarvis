...
def validate_static_wiring(failures: list[str]):
    ...
    for token in (
        ...
        "windowResizeBehavior\", \"uiref-007-frameless-top-level-hover-polled-edge-corner-cursor-app-owned-fallback-8px-edge-12px-corner-no-visible-grip-splitter-travel-76-270-horizontal-overflow-minimum-684x388-dynamic-content-minimum-maximum-840x610-close-intercept-v41",
