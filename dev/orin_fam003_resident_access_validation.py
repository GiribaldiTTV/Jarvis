...
def validate_static_wiring(failures: list[str]):
    ...
    for token in (
        ...
        "settingsVisualRepair\", \"lv1-global-settings-title-layout-watermark-deferral-repair-v22",
        ...
        "windowResizeBehavior\", \"frameless-top-level-hover-polled-edge-corner-cursor-app-owned-fallback-8px-edge-12px-corner-no-visible-grip-splitter-dynamic-row-count-minimum-590x338-maximum-860x560-v27",
        "quickAccessLayoutPolicy\", \"content-driven-card-window-grow-disable-before-break-v27",
        ...
        "setHandleWidth(9)",
        "subtle-1px-visible-affordance-9px-hit-zone-v27",
