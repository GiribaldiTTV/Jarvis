    ...
    *,
    ...
    if is_fam006_active_overlay_implementation and fam006_bp3_packet:
        ...
        lines = [
            ...
            "## What Will I Actually See, And Where Will I See It?",
            "",
            "- USER will see the future Dashboard Recording card as the small recording target/status and future-control surface.",
            "- USER will treat any future Recording Control window or secondary detail surface as optional later detail, not the active BP3 center.",
            ...
            "## How It Will Function",
            "",
            "The future implementation should derive the recording target from active Overlay Profile membership and use snapshot-at-start semantics. BP3 validates whether the accepted BP2 plan can enter Workstream safely while preserving Dashboard Recording card target/status behavior, HUD Overlay preservation, target-state behavior, stale/missing-target handling, rollback, H1, LV, and UTS expectations.",
            "",
            "## User Experience Flow",
            "",
            "1. USER reviews or selects the active Overlay Profile.",
            "2. USER sees concise recording target/status information in the Dashboard Recording card after later implementation approval.",
            "3. USER treats any secondary recording detail surface as future-only unless BP3 and later implementation approval admit it.",
            ...
            "- Option C - future/secondary detail surface only if BP3 and later implementation approval admit it.",
            ...
            "- Recommendation 2: keep the Dashboard Recording card small and readable while keeping the HUD Overlay card overlay-focused.",
            ...
            "- Does BP3 keep the Dashboard Recording card small enough while preserving the HUD Overlay card as overlay-focused?",
            ...
            *_markdown_lines(accepted_bp1_lines),
            ...
            "- Do not clutter the HUD Overlay card with recording detail or make a secondary detail surface active by default.",
            ...
            *_markdown_lines(pending_user_decisions),
            ...
            "- Accepted: Dashboard Recording card is the primary recording target/status surface while any Recording Control or secondary detail surface remains future/secondary.",
    ...
    if is_fam006_active_overlay_implementation and fam006_bp2_packet:
        ...
        lines = [
            ...
            "",
            "- USER will see the future Dashboard Recording card as the small recording target/status and future-control surface.",
            "- USER will treat any future Recording Control window or secondary detail surface as optional later detail, not the active BP2 center.",
            "- USER will inspect Overlay Profile membership as the source of target membership before recording starts.",
            ...
            "1. USER reviews or selects the active Overlay Profile.",
            "2. USER sees concise recording target/status information in the Dashboard Recording card after later implementation approval.",
            "3. USER treats any Recording Control window or secondary recording detail surface as future/secondary unless later admitted.",
            "4. A later approved recording session snapshots target membership at Start.",
            "5. Sensors added during recording become eligible for the next session.",
            "",
            "## Surface Map",
            ...
            "- Recommendation 2: keep the Dashboard Recording card small and readable while preserving the HUD Overlay card as overlay-focused; risk is under-informing the card if BP2/BP3 do not define fields tightly enough.",
            ...
            "- Does the BP2 plan keep the Dashboard Recording card small enough while preserving HUD Overlay focus and future-secondary detail boundaries?",
