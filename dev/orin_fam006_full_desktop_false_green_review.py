...
def _root_cause_rows() -> list[dict[str, str]]:
    return [
        ...
        },
        {
            ...
            "falseGreenSymptom": "The 153501 packet carried the accepted selected visual direction but did not include packet-contained command evidence for every proof command Codex claimed in the return packet.",
            "evidenceThatExposedIt": "USER/ChatGPT review of FAM-006-20260624-153501.zip and the Codex return packet listing proof commands that were not all backed by in-ZIP command records.",
            "whyPacketProofMissedIt": "The packet summarized command results and included many raw records, but did not require a command-claim ledger tying each PASS/NA claim to packet-contained command/cwd/timestamp/exit/stdout/stderr evidence.",
            "whyValidatorHelperMissedIt": "The branch-local packet gate checked core command-output records but did not require self-check proof, USER packet proof, external-state proof, git diff cached applicability, or exact claim-to-evidence parity.",
            "whyCodexReviewMissedIt": "Codex treated the final chat command summary and packet helper PASS as sufficient instead of proving every claimed command inside the upload artifact.",
            "whyChatGPTReviewMissedIt": "The upload packet lacked a deterministic command-claim ledger, so ChatGPT had to infer which proof commands were actually packet-contained.",
            "sourceTruthOwnerGap": "FAM-006 packet repair source truth did not explicitly require selected-direction packets to fail closed on summary-only command claims.",
            "validatorToolingGap": "No branch-local helper required a command-claim ledger, post-ZIP packet proof, external-state proof, and final clean branch proof in the packet.",
            "repairRequired": "Add command-claim ledger generation, packet-contained command-output records for every claimed proof command, post-ZIP packet/external proof evidence, and final clean git proof.",
            "futurePreventionRule": "Selected-direction packets must fail closed if any command claim lacks packet-contained evidence or if post-ZIP proof placeholders survive.",
            "proofRequiredToClose": "Packet contains a command-claim ledger, command records for all claimed proof commands, post-ZIP proof evidence, and final clean branch proof.",
        },
    ]
