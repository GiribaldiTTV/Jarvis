...
REQUIRED_CROP_COMPLETENESS = {
    ...
    "native-log-destination-action": {**DEFAULT_CROP_RULE, "minWidth": 350, "minHeight": 28},
    "exported-log-destination-action": {**DEFAULT_CROP_RULE, "minWidth": 350, "minHeight": 28},
...
REQUIRED_SCOPE_TEXT = {
    ...
    "log-viewer-window-chrome": ["RECORDING LOGS", "LOG VIEWER STUDIO", "NATIVE", "Recordings folder", "OPEN NATIVE LOGS", "EXPORT", "Exported Logs folder", "OPEN EXPORTED LOGS"],
    "native-log-destination-action": ["NATIVE", "Recordings folder"],
    "exported-log-destination-action": ["EXPORT", "Exported Logs folder"],
    "log-viewer-action-status": ["RECORDING LOGS", "LOG VIEWER STUDIO", "NATIVE", "Recordings folder", "OPEN NATIVE LOGS", "EXPORT", "Exported Logs folder", "OPEN EXPORTED LOGS"],
    "log-viewer-resize-before": ["RECORDING LOGS", "LOG VIEWER STUDIO", "NATIVE", "Recordings folder", "OPEN NATIVE LOGS", "EXPORT", "Exported Logs folder", "OPEN EXPORTED LOGS", "Exported logs folder could not be opened."],
    "log-viewer-resize-during": ["RECORDING LOGS", "LOG VIEWER STUDIO", "NATIVE", "Recordings folder", "OPEN NATIVE LOGS", "EXPORT", "Exported Logs folder", "OPEN EXPORTED LOGS", "Exported logs folder could not be opened."],
    "log-viewer-resize-after": ["RECORDING LOGS", "LOG VIEWER STUDIO", "NATIVE", "Recordings folder", "OPEN NATIVE LOGS", "EXPORT", "Exported Logs folder", "OPEN EXPORTED LOGS", "Exported logs folder could not be opened."],
}
