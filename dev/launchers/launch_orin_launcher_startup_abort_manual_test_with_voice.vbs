...
Env("NEXUS_HARNESS_TARGET_SCRIPT") = Fso.BuildPath(Fso.BuildPath(DevDir, "targets"), "orin_manual_startup_abort_target.pyw")
Env("NEXUS_HARNESS_LOG_ROOT") = Fso.BuildPath(Fso.BuildPath(DevDir, "logs"), "manual_launcher_startup_abort_test_with_voice")
