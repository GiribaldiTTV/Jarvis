...
def validate() -> list[str]:
    ...
    for needle in (
        ...
        "Computer Use is prohibited for Nexus validation and runtime-control work",
        "governed visible real-cursor human-client input is the supported desktop-control path",
        "Visible Desktop Coordinate Control",
