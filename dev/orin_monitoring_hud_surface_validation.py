...
def validate() -> list[str]:
    ...
    for needle in (
        ...
        'aria-label="Dashboard monitor group selector and configuration entry point"',
        'aria-hidden="true"',
        "Nexus Desktop AI",
        "Monitoring HUD",
        "Monitoring Control Panel",
        "Configures HUD capability, monitor groups, provider truth, warning posture, and future overlay behavior.",
        "Dashboard surface",
        ...
        'data-dashboard-content="monitor-group-settings-list"',
        ...
        "2 monitor groups configured; Dashboard edits settings while Overlay owns display cards.",
        "CPU Group",
        "GPU Group",
        "Provider setup required",
        "Enabled in future overlay",
        "Monitor groups organize sensors; dashboard does not render display cards or fake values.",
        'data-dashboard-content="provider-setup"',
        'data-dashboard-content="future-overlay-behavior"',
        'data-dashboard-content="dashboard-controls"',
        'data-dashboard-content="readiness-states"',
        'data-dashboard-content="dashboard-proof-next-actions"',
        "Provider setup",
        "Declare what data can be trusted",
        "Waiting for safe provider",
        "Provider-first; no fake values",
        "1s after provider proof",
        "Future overlay behavior",
        "Prepare, do not accept, Overlay display",
        ...
        "Control Overlay posture without accepting it",
        "Store group/layout posture locally",
        "Readiness states",
    ...
    for needle in (
        ...
        "proofStandard",
        "WS35 Dashboard-specific static/live proof screenshots and UTS handoff refresh proof",
        "primaryInterfaceReleaseSurface",
        ...
        "dashboardUserTestSummaryHandoffRefreshed",
        "dashboardUserTestSummaryHandoffPath",
        ...
        "userTestSummaryHandoffRefreshed",
