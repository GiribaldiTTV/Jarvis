...
def validate() -> list[str]:
    ...
    for needle in (
        ...
        'data-feature-studio-primitive="fam006-unique-child-studio-shell-v4"',
        ...
        'data-feature-studio-body-primitive="unique-child-purpose-stack-v4"',
        'data-controller-primitive="ultra-light-recording-controller"',
        'data-log-shell-primitive="compact-folder-access-shell"',
