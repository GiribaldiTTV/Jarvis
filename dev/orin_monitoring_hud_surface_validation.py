...
def validate() -> list[str]:
    ...
    for needle in (
        ...
        'id="monitoring-hud-edit-monitor"',
        ...
        "HUD display deferred",
        "Dashboard controls future HUD display",
        "Tray feature toggle",
        "No default keybinds",
        ...
        'data-dashboard-hub-card="hud-display"',
        'data-dashboard-hub-card="warning-notifications"',
        ...
        "CPU Group",
        "GPU Group",
        "Monitor Groups organize what the future HUD displays; the Dashboard does not render display cards or fake values.",
        "Waiting for safe provider",
        "Provider-first; no fake values",
        "Future HUD display is deferred.",
        "Deferred / non-gating",
        "Prepared for future HUD display branch",
        "Global visual warnings can be muted here without overwriting individual Monitor Group settings.",
