...
def validate() -> list[str]:
    ...
    for needle in (
        ...
        "Profile to Edit:",
        'data-recording-profile-state="slc-047-selection-editing-shell"',
    ...
    for needle in (
        ...
        "monitoringHudRecordingProfileSchemaVersion",
        "monitoringHudDefaultRecordingProfileId",
        "monitoringHudNormalizeOverlayProfileState",
        "monitoringHudNormalizeRecordingProfileState",
    ...
    for needle in (
        ...
        "relationship_proof_slice",
        "relationship_monitor_count",
        "relationship_source_count",
        "relationship_boundary",
        "recording_execution_boundary",
    ...
    for needle in (
        ...
        "recordingProfileValidationProof",
        "FAM-006 Recording Profile Runtime Foundation LV1",
