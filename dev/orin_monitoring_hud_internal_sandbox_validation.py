...
def _validate_static_surface(failures: list[str]) -> None:
    ...
    for needle in (
        ...
        'data-resize-live-proof="during-drag-frame-pixel-signature-grow-shrink"',
        ...
        'data-monitor-management="create-edit-delete-sensor-assignment"',
        'data-monitor-management-scale="split-layout-search-filter-large-fixtures"',
        'data-monitor-management-layout="sticky-header-left-list-right-detail"',
        'data-sensor-library-scale="search-filter-thousand-source-fixture"',
        ...
        'data-monitor-group-flow="manage-list-create-edit-delete-sensor-assignment"',
        ...
        'data-monitor-management-layout="split-list-detail"',
        ...
        'data-monitor-delete="cpu"',
        'data-monitor-sensor-option="cpu-load"',
        'data-sensor-assignment="available-runtime-sources"',
        "Sensor / data-source assignment",
        "Provider Readiness",
        "Display mode",
        "Monitor Groups",
        "Data Sources",
    ...
    for needle in (
        ...
        'body.desktop-mode #monitoring-hud[data-live-resize-active="true"] .monitoring-hud__chrome',
        "width: 6px;",
        "margin: 10px 0 14px;",
    ...
    for needle in (
        ...
        "monitoringHud.style.setProperty(\"--monitoring-hud-live-resize-proof-alpha\"",
        "monitoringHud.style.setProperty(\"--monitoring-hud-live-resize-proof-x\"",
        "monitoringHud.style.setProperty(\"--monitoring-hud-live-resize-proof-y\"",
    ...
    for needle in (
        ...
        "--monitoring-hud-live-resize-proof-alpha",
...
def _validate_contracts(failures: list[str]) -> dict[str, object]:
    ...
    _require(
        controls.get("monitorManagement") == "Dashboard creates, edits, deletes with confirmation, assigns supported sources, and sets polling for monitor groups",
