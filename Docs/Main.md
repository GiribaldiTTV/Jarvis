...
- for relevant desktop user-facing Live Validation Stage 1 runs, export or refresh `D:\Nexus Desktop AI\USER\User Test Summary.txt` unless an explicit exception from `Docs/user_test_summary_guidance.md` applies; Desktop / OneDrive copies are mirror-only unless USER grants a later exception
