...
- Product and identity intent: `Docs/nexus_vision.md` owns current product intent for `Nexus Desktop AI` and the `ORIN` assistant layer; it records that older Nexus releases are preserved history and do not define the active public Nexus release line.
...
| Current product and architecture canon | `Docs/nexus_vision.md`, `Docs/architecture.md`, `Docs/orchestration.md`, `Docs/boot_access_design.md`, `Docs/orin_display_naming_guidance.md` | Product, architecture, orchestration, boot-planning, and persona-display layers | May distinguish `Nexus Desktop AI` product identity, `ORIN` assistant identity, current runtime truth, future planning, and historical notes. Must preserve exact runtime path names. |
