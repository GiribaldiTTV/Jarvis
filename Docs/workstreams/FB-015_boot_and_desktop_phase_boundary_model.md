...
Post-Release Truth: FB-015 and FB-029 are Released / Closed in v1.6.4-prebeta; FB-030 is Released / Closed in v1.6.5-prebeta; FB-005 is Released / Closed in v1.6.6-prebeta; release debt is clear; and FB-042 is now the active promoted implementation workstream on `feature/fb-042-desktop-entrypoint-runtime-refinement`, with Branch Readiness complete, WS-1 desktop shortcut launch-path runtime refinement complete / validated, H-1 hardening complete, and LV-1 complete
