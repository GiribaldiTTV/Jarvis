...
- FB-030 is released and closed in `v1.6.5-prebeta`; FB-005 is now released and closed in `v1.6.6-prebeta`; FB-042 is now Released / Closed in `v1.6.7-prebeta`; FB-043 is Released / Closed in `v1.6.8-prebeta`; and FB-044 remains selected-only / `Registry-only` on `feature/fb-044-boot-desktop-handoff-outcome-refinement` during Branch Readiness.
