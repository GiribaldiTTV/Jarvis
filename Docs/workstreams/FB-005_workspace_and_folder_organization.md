...
- Canonical FB-042 truth now lives in `Docs/workstreams/FB-042_desktop_entrypoint_runtime_refinement.md`, and WS-1 desktop shortcut launch-path runtime refinement plus H-1 hardening are complete with Live Validation next.
