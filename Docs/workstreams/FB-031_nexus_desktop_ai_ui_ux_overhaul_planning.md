...
- Source-of-Truth Gap: no duplicate source-of-truth owner is needed. The backlog owns FB-031 identity and minimal scope, the roadmap owns stage-breakpoint/checkpoint reference posture, and this workstream doc owns the branch-local UI/UX architecture, lifecycle/state framing, validation/admission contract, and H-1 hardening evidence.
