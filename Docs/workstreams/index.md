...
- runtime-focused implementation workstreams may also point to a Branch Runtime Engineering Plan under `Docs/branch_plans/<branch_slug>.md`; that plan owns detailed active-branch implementation checklists, validation checklists, and user-facing proof checklists while backlog and roadmap stay compact pointer/status surfaces
