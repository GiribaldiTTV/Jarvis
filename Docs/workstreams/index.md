...
- for relevant desktop slices, `C:\Nexus USER\User Test Summary.txt` is the required user-facing exported copy unless an explicit documented exception applies
