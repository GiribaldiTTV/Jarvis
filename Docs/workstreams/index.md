...
| `FAM-006` | `PKG-006` | Monitoring and HUD | `FB-040` historical architecture proof plus active Branch Readiness authority in `Docs/branch_records/codex_fam_006_monitoring_hud_product_surface.md` until Workstream promotion |
