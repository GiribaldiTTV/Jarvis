...
- for relevant desktop slices, `D:\Nexus Desktop AI Data\USER\User Test Summary.txt` is the required user-facing exported copy unless an explicit documented exception applies
