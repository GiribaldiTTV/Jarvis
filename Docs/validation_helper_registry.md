...
| Path | Helper Status | Family | Reuse / Consolidation |
| --- | --- | --- | --- |
| `dev/orin_monitoring_hud_surface_validation.py` | Helper Status: Reusable | monitoring HUD surface validator | Reuse for static Monitoring/HUD visual-surface markers, desktop-mode activation, runtime telemetry-boundary markers, renderer-owned placement markers, controls-visibility markers, fail-safe/no-data/degraded-status behavior markers, slice-boundary copy, no-hardware-polling/no-settings-persistence/no-fake-hardware-values/no-recovery-claims/no-voice boundary checks, no expanded retired legacy user-facing identity, Stage 2-R11 dashboard-versus-minimal-HUD architecture expectations, WS18/WS30 Core desktop-layer/non-blocking ownership markers, WorkerW coordinate-rebase proof, no Core topmost foreground ownership, WS19 dashboard/minimal-HUD split markup/CSS/JS/runtime-marker contracts, WS20 dashboard configuration-content markers, WS21 movement/scrollbar polish markers, WS22 native minimal-overlay click-through/no-focus markers, WS24 dashboard monitor-management / overlay-mode control markers, WS25 edgeless overlay/display canvas markers, WS26 standalone native overlay/display window plus anchored-uninteractable/position-preservation markers, WS27 revised-overlay manifest proof fields, WS28 dashboard/overlay/Core native-surface independence plus overlay-owned monitor-card drag/resize markers, WS29 before/after screenshot proof fields, and WS30 desktop-specific Core render file / fixed preset-monitor / non-movable / Core-HUD surface-separation markers before creating another HUD surface validator. |
| `dev/orin_monitoring_hud_live_validation.ps1` | Helper Status: Reusable | monitoring HUD live desktop validator | Workstream/Live Validation helper for FAM-006 Monitoring HUD proof. Reuse for launched-desktop marker proof, Core desktop-layer/non-interference runtime markers, dashboard/minimal-HUD split runtime markers, dashboard-content runtime marker, dashboard movement/scrollbar runtime markers, native minimal-overlay click-through/no-focus runtime markers, WS25 edgeless overlay/display canvas runtime marker proof, WS26 standalone overlay/display native-window and anchored-uninteractable/position-preservation runtime marker proof, WS27 revisedOverlayProof manifest checklist, WS28 standaloneDashboardWindowReady/surfaceNativeIndependenceReady/overlayCardsMovableReady proof, WS29 before/after full virtual-desktop screenshot capture, WS30 coreWorkerwCoordinateRebaseReady/coreHudSurfaceSeparationReady manifest proof plus fixed preset-monitor/non-movable Core markers, `C:\Users\anden\OneDrive\Pictures\Screenshots\Nexus Desktop AI\fam_006_monitoring_hud_live_validation\<stamp>\` raw PNG evidence copies for USER inspection, `-RunInteractionSelfQA` live HUD control exercise, `-ActiveUserFacingClient` foreground/user-observable validation, interaction manifest output, no-progress watchdog, and cleanup verification before creating another HUD live-proof helper. Remaining gaps before future package-complete claims: Hardening rerun, Live Validation rerun, and formal returned-UTS acceptance. |
| `dev/orin_monitoring_hud_internal_sandbox_validation.py` | Helper Status: Reusable | monitoring HUD internal sandbox validator | Use for FAM-006 Workstream and Hardening internal product proof. Validates the standalone HUD shell/module files, verifies the ORIN Core render files remain HUD-free, desktop-layer-owned, non-blocking, desktop-file-scoped, fixed/non-movable, WorkerW-coordinate-rebased, and preset-monitor-owned, validates dashboard/minimal-HUD split markers, dashboard configuration-content markers, dashboard movement/scrollbar polish markers, native minimal-overlay click-through/no-focus markers, WS24 dashboard monitor-management and overlay-mode control markers, WS25 edgeless overlay/display canvas markers, WS26 standalone native overlay/display window ownership and anchored-uninteractable/position-preservation markers, WS27 revised-overlay proof expansion posture, WS28 dashboard/overlay/Core native-surface independence and overlay-owned card editing posture, WS29 Workstream completion posture, WS30 Core/HUD surface separation posture, tray/unanchor path, anchored click-through versus unanchored edit mode, draggable/resizable/snapping category-card model, provider-truthful telemetry contracts, 1s polling floor, visual warning posture, no fake GPU/thermal values, and retired-name sterilization without treating User Test Summary results as a Workstream or Hardening gate. Remaining gaps before future package-complete claims: Hardening rerun, Live Validation rerun, and formal returned-UTS evidence. |
