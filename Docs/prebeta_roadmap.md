...
Selected Next Current-Carrier Note: `feature/fam-006-monitor-groups-sensor-configuration` is the current Repair Workstream implementation carrier after reconciliation; it is not authority for FAM-007 work.
Selection Scope: This branch carries FAM-006 Monitor Groups / Sensor Command Center repair implementation and next Hardening H1. PR #162/FAM-007 source truth is preserved as current-main context only and remains routed to the FAM-007 lane.
