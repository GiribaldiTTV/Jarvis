...
- next legal phase: SLC-040 Hardening H1 for `feature/fam-006-overlay-profile-runtime-foundation`. Release Readiness Stage 2, SLC-041 implementation, issue work, artifacts beyond GitHub source archives, branch cleanup, provider SDK/model work, memory/indexing implementation, voice/Core runtime sync, shortcut/installer work, release, AI Product Contract import, Private Dev ORIN import, and any additional runtime branch creation require separate USER approval.
...
Closure Drift Scope: release-dependent fields only.
Implementation Entry: SLC-040 Manage Monitors read-only Overlay Profile context/settings-route integration is implemented on `feature/fam-006-overlay-profile-runtime-foundation`; SLC-040 Hardening H1 is the next legal phase after the approved compact layout, selector-width repair, SLC-038 H1, SLC-039 Workstream implementation/H1, and SLC-040 Workstream implementation. PR #190 and PR #191 are released source-truth context, with provider setup and execution pending separate USER decisions.
...
Runtime Implementation: SLC-037 Overlay Profile data/state foundation, SLC-038 visible selection/editing controls, SLC-039 settings-window monitor membership mapping, and SLC-040 Manage Monitors read-only Overlay Profile context/settings-route integration are implemented. Historical Monitor Groups repairs, Dashboard resize/right-edge repairs, Source Filter/Polling Rate/Source Picker behavior, dirty guard behavior, focused visual proof standards, and Sensor Command Center boundaries remain preservation requirements. SLC-040 H1, SLC-041 live proof beyond this seam, Recording Profile runtime, tray recording controls, export/share, provider SDKs, model downloads/execution, external calls, memory/indexing implementation, voice/Core sync, shortcut/installer work, release work, AI Product Contract import, private Dev ORIN import, FAM-007 work, and GitHub issue mutation remain blocked.
...
- Selected Next Runtime Package Candidate: `FAM-006 / PKG-006 Overlay Profile Runtime Foundation`
- Selected Next Status: `SLC-040 Overlay Profile Dashboard / Manage Monitors integration is Workstream Green after SLC-037 H1 Green, SLC-038 H1 Green, and SLC-039 H1 Green; Manage Monitors shows read-only active-profile context and routes to Overlay Profile Settings for membership edits; SLC-040 H1 is next`
