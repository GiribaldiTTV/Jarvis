...
- next concern: align `Docs/Main.md`, the routing layer, and the compact loader map in Phase 6 / Slice R6-S3 while preserving the converted roadmap family-anchor framing, the split workstream index, the stabilized FB-042 and FB-027 dossier routing, and FB-049 as selected next and branch-not-created.
