...
Release Blockers: None for `v1.7.8-prebeta` current-main tag context; current-main release-window posture remains Governance context, and FAM-006 PR Readiness remains blocked until refreshed LV1/UTS is green or USER gives an explicit waiver with reason.
