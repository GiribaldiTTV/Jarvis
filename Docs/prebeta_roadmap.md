...
Current Hardening State: Rerun required after WS47 - prior Hardening H1 remains supporting history only where not superseded, but it predates the WS47 tray/shortcut and proof-governance repair.
