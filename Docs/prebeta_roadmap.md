...
- unreleased non-doc implementation work exists: PR #152 merged FAM-007 local-only foundation continuation after `v1.7.1-prebeta` and is merged-unreleased until a later USER-approved release path includes it; branch-local FAM-006 Monitor Groups sensor configuration remains unmerged active repair work on `feature/fam-006-monitor-groups-sensor-configuration`. PR #129, PR #132, PR #138, and PR #142 are published in the latest prerelease. GitHub issue closeout/comments, branch/worktree cleanup, provider/model/shortcut/installer work beyond the local-only scaffold, Overlay acceptance, external telemetry parity, raw evidence handling, and AI Product work remain USER-gated.
...
- current phase after `v1.7.1-prebeta` publication: merged main remains No Active Branch after PR #152, while the branch-local FAM-006 lane is reconciling current main before returned UTS FAIL repair setup. PR #152 is historical merged-unreleased FAM-007 local-only scaffold scope and should be evaluated by a later USER-approved Release Readiness path. RRI-20260514-006 / PR #151 closed release-dependent canon drift before the FAM-007 continuation, and RRI-20260514-007 repairs the post-PR #152 active-authority closeout. PR #129, PR #132, PR #138, and PR #142 are released in v1.7.1; PR #143 through PR #151 are governance/readiness support; PR #152 is post-v1.7.1 implementation scope. FAM-006 Monitor Groups returned UTS FAIL repair and FAM-007 runtime/provider/model/shortcut/installer work beyond the local-only scaffold remain pending USER approval in their owning lanes.
...
Merged-Main Repo State: No Active Branch after PR #152; PR #152 is merged-unreleased FAM-007 scope, not an active branch authority.
