...
| `FAM-006` Monitoring and HUD | active-overlay recording runtime implementation carrier has BP1/BP2 accepted, BP3 approved, Workstream Green, Hardening H1 Green, and Live Validation LV1 proof/handoff Green; SLC-051 through SLC-055 are implemented; returned UTS results remain pending before PR Readiness; durable planning and release receipts preserved; future recording runtime remains USER-gated for later controls/execution; released planning traceability remains preserved in `Docs/branch_records/feature_fam_006_active_overlay_recording_runtime_foundation.md` | `Docs/family_visions/FAM-006_monitoring_and_hud.md` | `Docs/branch_records/feature_fam_006_active_overlay_recording_runtime_implementation.md` |
