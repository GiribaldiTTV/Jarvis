...
- next concern: Hardening H1 for the follow-up returned-UTS Overlay Profile manager, Manage Monitors assignment/status, and source-list sensor settings IA repair after SLC-041 Workstream implementation/H1 Green, LV1 technical proof/UTS handoff, returned USER UTS REPAIR digest, prior repair setup, returned-UTS Workstream implementation, follow-up repair setup, and follow-up Workstream implementation. PR Readiness Stage 1, Release Readiness Stage 2, runtime/provider SDK/model execution, shortcut/installer work, AI Product Contract full import, GitHub issue creation or closeout, release/tag/artifact work, raw evidence upload/import/linking, and `codex/ai-llm-lab` mutation remain outside this setup.
