...
| `FAM-007` Local AI and Capability Packs | local-only provider setup and consent readiness sequence is released through consent foundation; consent collection implementation foundation is PR Readiness Stage 1 Ready For Stage 2 with PR creation pending USER approval; provider execution and model work remain USER-gated | `Docs/family_visions/FAM-007_local_ai_and_capability_packs.md` | `Docs/branch_records/feature_fam_007_local_ai_provider_consent_collection_implementation_foundation.md` |
