...
| `FAM-006` Monitoring and HUD | Recording Profile Runtime Foundation LV1 helper proof is green on `feature/fam-006-recording-profile-runtime-foundation` after SLC-046 implementation/H1 green, SLC-047 selection/editing implementation/H1 green, SLC-048 relationship/boundary implementation/H1 green, SLC-049 Dashboard / Manage Monitors status integration implementation/package H1 green, SLC-050 Workstream readiness proof/package H1 green, and bounded LV1 real-input desktop proof; User Test Summary Results Pending blocks final LV1 green and PR Readiness; USER clarified future recording vision is active-overlay-driven rather than profile-loaded, with lightweight HUD Overlay Start/Stop, standalone Recording Settings, and recording of active Overlay Profile membership; Overlay Display Acceptance Foundation is released in `v1.7.19-prebeta` via PR #207; H1, LV1 proof refresh, USER Test Summary PASS/closed, and SLC-042 through SLC-045 are historical green; Dashboard, Sensor Command Center, and Overlay Profile foundation evidence are released receipts; historical Overlay Display Acceptance detail remains at `Docs/branch_records/feature_fam_006_overlay_display_acceptance_foundation.md`; historical Overlay Profile Runtime Foundation detail remains at `Docs/branch_records/feature_fam_006_overlay_profile_runtime_foundation.md`; recording execution, output files, export/share, provider/model work, broad theme/skin work, and future monitoring/HUD scope remains USER-gated | `Docs/family_visions/FAM-006_monitoring_and_hud.md` | `Docs/branch_records/feature_fam_006_recording_profile_runtime_foundation.md` |
