...
| `FAM-006` Monitoring and HUD | active-overlay recording runtime implementation carrier has BP1/BP2 accepted and BP3 approved; durable planning and release receipts preserved; future recording runtime remains USER-gated until separate bounded SLC-051 Workstream implementation approval; released planning traceability remains preserved in `Docs/branch_records/feature_fam_006_active_overlay_recording_runtime_foundation.md` | `Docs/family_visions/FAM-006_monitoring_and_hud.md` | `Docs/branch_records/feature_fam_006_active_overlay_recording_runtime_implementation.md` |
