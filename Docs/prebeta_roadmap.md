...
- current active workstream: H1 Green for FAM-007 Local AI Provider Consent Collection Foundation; Live Validation LV1 is pending USER approval.
- current branch after `v1.7.12-prebeta` tag context: `feature/fam-007-local-ai-provider-consent-collection-foundation` is the active H1 Green carrier; `feature/fam-007-local-ai-provider-setup-implementation-foundation` is historical released PR #192 evidence; `feature/fam-007-local-ai-provider-setup-contract-readiness` is historical released PR #190 evidence; `feature/repo-wide-source-owner-marker-adoption` remains historical PR #185 evidence, PR #186 is its fold-down repair evidence, PR #187 is release-window support publication evidence, and `feature/fam-006-monitor-groups-sensor-configuration` is historical released PR #180 evidence.
- next concern: Live Validation LV1 for the detailed FAM-007 consent collection foundation carrier after USER approval. Actual consent collection, provider setup, runtime/provider SDK/model execution, shortcut/installer work, AI Product Contract full import, GitHub issue creation or closeout, release execution, tag/artifact work, raw evidence upload/import/linking, and `codex/ai-llm-lab` mutation remain outside this H1 scope.
