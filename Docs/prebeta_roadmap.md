...
- unreleased non-doc implementation work: PR #190 FAM-007 setup contract readiness is merged-unreleased after `v1.7.10-prebeta`; PR #188 and PR #189 are merged-unreleased governance/source-truth support, and remaining provider setup, SDK/model, memory, voice/Core, shortcut/installer, issue, artifact, and release work remains USER-gated.
...
- current branch after `v1.7.10-prebeta` tag context: `feature/fam-007-local-ai-provider-setup-contract-readiness` is historical PR #190 merged-unreleased evidence; `feature/repo-wide-source-owner-marker-adoption` remains historical PR #185 evidence, PR #186 is its fold-down repair evidence, PR #187 is release-window support publication evidence, and `feature/fam-006-monitor-groups-sensor-configuration` is historical released PR #180 evidence.
- next concern: Release Readiness Stage 2 preparation for the `v1.7.11-prebeta` candidate. Runtime/provider SDK/model execution, shortcut/installer work, AI Product Contract full import, GitHub issue creation or closeout, release execution, tag/artifact work, raw evidence upload/import/linking, and `codex/ai-llm-lab` mutation remain outside this source-truth repair.
...
- next legal phase: Release Readiness Stage 2 preparation for `v1.7.11-prebeta`; release execution, issue work, artifacts beyond GitHub source archives, branch cleanup, provider SDK/model work, memory/indexing implementation, voice/Core runtime sync, shortcut/installer work, AI Product Contract import, Private Dev ORIN import, and future runtime branch creation require separate USER approval.
...
Current Carrier Branch: None - active carrier identity lives in the branch authority record.
