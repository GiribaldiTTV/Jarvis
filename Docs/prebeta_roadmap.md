...
- next concern: add the final hard anti-drift checks in Phase 7 / Slice R7-S2 while preserving the converted roadmap family-anchor framing, the split workstream index, the aligned routing/loader surfaces, the validated FB-049 selected-next lock, and the now-finalized reform-shape validator baseline.
