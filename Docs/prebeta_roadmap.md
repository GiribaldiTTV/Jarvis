...
- next concern: add the validator/helper and artifact index structures in Phase 4 / Slice R4-S4 while preserving the new FB-042 and FB-027 dossier pass-index and slice/seam-ledger templates, the hardened Workstream-completion continuation rule, and FB-049 as selected next and branch-not-created.
...
- lifetime dossier state: structured shell; Phase 4 / Slice R4-S3 added pass index and slice/seam ledger templates, and no historical pass migration has landed yet
