...
| `FAM-006` Monitoring and HUD | Overlay Display Acceptance Foundation successor setup is active; Dashboard, Sensor Command Center, and Overlay Profile foundation evidence are released receipts; broader monitoring/HUD scope remains USER-gated | `Docs/family_visions/FAM-006_monitoring_and_hud.md` | `Docs/branch_records/feature_fam_006_overlay_display_acceptance_foundation.md` |
