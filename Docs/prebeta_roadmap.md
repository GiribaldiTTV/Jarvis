...
- current phase after `v1.7.0-prebeta` publication: FAM-006 Dashboard settings-panel Branch Readiness Stage 2 is active on `feature/fam-006-dashboard-settings-panel`; this carrier repairs post-PR #133 source-truth drift, establishes the next runtime-focused Dashboard settings-panel authority, and preserves PR #129 / PR #132 merged-unreleased release debt. PR #130 and PR #131 are merged FAM-007 governance/readiness history while FAM-007 runtime/provider/model/shortcut/installer implementation remains pending USER approval.
