...
- unreleased non-doc implementation work: PR #162 merged `feature/fam-007-local-ai-runtime-expansion` as FAM-007 local AI runtime contracts and capability foundation merged-unreleased release-window scope. PR #155 through PR #161 are released historical scope. The FAM-007 branch completed the local-only FAM-007 Local AI Runtime Contracts and Capability Foundation Workstream through SLC-036 before merge; remaining provider SDK/model/memory/voice/Core/shortcut/installer/release work remains USER-gated.
...
- current phase after PR #162 merge: Release Readiness Stage 1 rerun from updated `origin/main` after the standing Governance post-PR #162 closure repair reaches main. PR #162 is merged-unreleased FAM-007 local AI runtime contracts and capability foundation scope; PR #159 is released historical FAM-007 local-only runtime foundation scope in v1.7.3. FAM-007 provider SDK/model/shortcut/installer work remains pending USER approval.
...
- current branch after PR #162 merge: no active runtime/product branch on main; `feature/fam-007-local-ai-runtime-expansion` is historical merged-unreleased release-window scope; `feature/release-readiness-source-truth-intake` is the projected idle standing governance intake carrier after RRI-20260518-001 with Active RRI Cycle: None.
- next concern: Release Readiness Stage 1 rerun from updated `origin/main` after the standing Governance post-PR #162 closure repair merges and returns the FAM-007 rebaseline digest. Runtime/provider SDK/model execution, shortcut/installer work, AI Product Contract full import, GitHub issue creation or closeout, release/tag/artifact work, raw evidence upload/import/linking, and `codex/ai-llm-lab` mutation remain outside this Workstream.
...
- next legal phase: Release Readiness Stage 1 from updated `origin/main` after the standing Governance post-PR #162 closure repair merges and returns the FAM-007 rebaseline digest. Provider SDK/model work, memory/indexing implementation, voice/Core runtime sync, shortcut/installer work, release execution, AI Product Contract import, Private Dev ORIN import, and GitHub issue creation require separate USER approval.
...
Release-Debt Avoidance Status: PR #162 is merged-unreleased FAM-007 release-window scope; release execution remains USER-gated and FAM-007 runtime expansion, provider/model/memory/shortcut/installer work, Overlay acceptance, and AI Product work remain separate USER-gated decisions.
Merged-main current active workstream: None after PR #162 merge
...
Next Legal Phase: Release Readiness Stage 1 from updated `origin/main` after the standing Governance post-PR #162 closure repair merges and returns the FAM-007 rebaseline digest; release work, issue work, provider SDK/model work, memory/indexing implementation, voice/Core runtime sync, shortcut/installer work, and AI Product Contract import remain separate USER decisions.

## Selected Next Workstream

Selected Next Workstream: FAM-006 Monitor Groups / Sensor Command Center returned USER UTS FAIL repair planning/setup.
Backlog Record State: Registry-only.
Record State: Current-main reconciliation and Branch Readiness repair setup on `feature/fam-006-monitor-groups-sensor-configuration`; PR #163 main truth remains context only.
Minimal Scope: Branch Readiness repair setup for newly returned FAM-006 blockers only: first-launch Dashboard flicker, Source Filter Nexus-styled dropdown, dropdown hover reset, 20+ monitor-group scrollbar stress proof, bottom/right delete placement, top-area compaction, taller/resizable Manage Monitors window, copy cleanup, visible resize-proof contamination regression prevention, and invisible/test-gated proof preservation.
...
Selected Next Current-Carrier Note: `feature/fam-006-monitor-groups-sensor-configuration` is the current Branch Readiness repair setup carrier after reconciliation; it is not authority for FAM-007 work.
Selection Scope: This branch carries FAM-006 Monitor Groups / Sensor Command Center repair setup. PR #162/FAM-007 source truth is preserved as current-main context only and remains routed to the FAM-007 lane.
...
Runtime Implementation: Pending later USER approval after repair setup. Provider SDKs, model downloads/execution, external calls, memory/indexing implementation, voice/Core sync, shortcut/installer work, release work, AI Product Contract import, private Dev ORIN import, FAM-007 work, and GitHub issue mutation remain blocked.
