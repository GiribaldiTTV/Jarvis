...
- current phase after PR #161 merge: merged main remains No Active Branch after PR #161; PR #159 is merged-unreleased FAM-007 scope in its owning lane; branch-local FAM-006 has completed current-main reconciliation and keeps returned UTS FAIL repair implementation plus Hardening H1 green pending refreshed Live Validation/UTS. PR #160 and PR #161 closed the post-PR #159 source-truth drift, and PR #152 is historical released FAM-007 local-only scaffold scope. FAM-006 Monitor Groups refreshed Live Validation/UTS and FAM-007 release/closeout handling remain separate USER-gated decisions in their owning lanes.
...
- next concern: refreshed Live Validation / UTS recheck for the FAM-006 returned UTS FAIL path after current-main reconciliation, plus separately USER-approved FAM-007 Release Readiness or future Branch Readiness in that owning lane. Runtime/provider/model/shortcut/installer work, AI Product Contract full import, GitHub issue creation or closeout, release/tag/artifact work, raw evidence upload/import/linking, and `codex/ai-llm-lab` mutation remain outside this historical carrier.
