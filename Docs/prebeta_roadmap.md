...
- next concern: validate selected-next truth across backlog, roadmap, branch authority, and validator expectations in Phase 6 / Slice R6-S4 while preserving the converted roadmap family-anchor framing, the split workstream index, the aligned routing/loader surfaces, and FB-049 as selected next and branch-not-created.
