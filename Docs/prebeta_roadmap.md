...
- current active workstream: `FAM-006 Overlay Profile Runtime Foundation` on `feature/fam-006-overlay-profile-runtime-foundation`; merged main remains no-active-branch by inertia after PR #191, and FAM-007 Local AI Provider Setup Contract Readiness is historical merged-unreleased context.
- current branch after `v1.7.10-prebeta` tag context: USER approved Branch Readiness Stage 2 setup for `feature/fam-006-overlay-profile-runtime-foundation` in `C:\Nexus Worktrees\FAM-006`; `feature/fam-007-local-ai-provider-setup-contract-readiness` is current-main FAM-007 context, `feature/repo-wide-source-owner-marker-adoption` is historical PR #185 evidence, PR #186 is its fold-down repair evidence, PR #187 is release-window support publication evidence, PR #191 is release-readiness source-truth context, and `feature/fam-006-monitor-groups-sensor-configuration` is historical released PR #180 evidence.
