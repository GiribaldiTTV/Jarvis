...
- unreleased non-doc implementation work exists: yes - PR #129 merged FAM-006 Dashboard render/layout hardening, PR #132 merged FAM-006 Dashboard IA/control follow-through, and PR #134 merged FAM-007 provider-boundary / no-provider shell after `v1.7.0-prebeta`; they remain unreleased until a later USER-approved release path publishes them. PR #129/#132 release-support remains separate and USER-gated; PR #118 and PR #119 remain published in `v1.7.0-prebeta`.
- the latest public released implementation milestone is `FAM-006` Monitoring HUD Dashboard Product Surface in `v1.7.0-prebeta`, with Dashboard acceptance classified USER WAIVED/PASSABLE for the current Dashboard-first surface; earlier public released implementation milestones include `FAM-001` legacy `FB-049` Active-session pre-settled incoming-launch conflict truth and `FAM-004` legacy `FB-030` voice/audio runtime diagnostics proof in `v1.6.13-prebeta`; FB-048 Active-session relaunch signal-failure and wait-timeout truth in `v1.6.12-prebeta`; FB-047 Active-session relaunch decline session-preservation proof in `v1.6.11-prebeta`; FB-046 Active-session relaunch reacquisition and settled re-entry proof remains released in `v1.6.10-prebeta`; FB-044 Boot-to-desktop handoff outcome refinement and FB-045 Active-session relaunch outcome refinement remain released in `v1.6.9-prebeta`; FB-043 Top-level desktop entrypoint ownership and `main.py` handoff refinement remains released in `v1.6.8-prebeta`; FB-042 Desktop startup runtime family anchor remains released in `v1.6.7-prebeta`; FB-005 Workspace and folder organization remains released in `v1.6.6-prebeta`; FB-030 ORIN voice/audio direction refinement remains released in `v1.6.5-prebeta`; FB-015 Boot and desktop phase-boundary model plus FB-029 ORIN legal-safe rebrand, future ARIA persona option, and repo licensing hardening remain released in `v1.6.4-prebeta`
- current phase after `v1.7.0-prebeta` publication: PR #134 merged the first bounded FAM-007 provider-boundary / no-provider shell SLC-017/SLC-018 scaffold as merged-unreleased scope; PR #135 repaired merged-main closure; this branch-local rebaseline selected `feature/fam-007-provider-boundary-no-provider-shell` as the active FAM-007 foundation/runtime carrier; commit 439979fc1204c08cb82af8e95abf7023a311d0d9 is preserved as completed local-only provider-selection/consent-boundary scaffold evidence; SLC-017, SLC-018, SLC-031, SLC-032, SLC-033, SLC-034, SLC-035, and SLC-036 are green as same-branch local-only scaffolds; FAM-007 Hardening H1 is green; Live Validation LV1 is green with formal UTS/live-client proof waived for the disabled/status-only scaffold; and PR Readiness Stage 1 is green after bounded repair.
...
- current active workstream: FAM-007 Provider Boundary And No-Provider Shell - PR #134, commit 439979fc1204c08cb82af8e95abf7023a311d0d9, disabled Assisted Desktop no-provider interaction/consent, local provider registry/configuration, hardware/capability planning, capability-pack lifecycle planning, data/memory/consent/audit/secrets planning, Windows resilience planning, persona/Core/voice boundary, validation proof-gate scaffolds, Hardening H1 proof review, Live Validation LV1 waiver proof, and PR Readiness Stage 1 proof are green branch evidence, and FAM-006 release-support remains separate and release execution remains USER-gated.
- active runtime branch after `v1.7.0-prebeta` publication: `feature/fam-007-provider-boundary-no-provider-shell`; PR #134 merged its first bounded runtime seam, PR #135 repaired merged-main closure, and this branch-local reconcile moves the branch authority back to active runtime-carrier truth.
- next concern: PR Readiness Stage 2 for `feature/fam-007-provider-boundary-no-provider-shell` after explicit USER approval, limited to final live PR-readiness verification, PR creation targeting `main`, PR body creation, watcher/reporting setup, and live PR state reporting. Real provider SDK integration, model downloads, memory/indexing, voice/Core sync, shortcut/installer work, AI Product Contract full import, GitHub issue creation or closeout, merge, release/tag/artifact work, raw evidence upload/import/linking, PR #129/#132 release execution, and `codex/ai-llm-lab` mutation remain outside this carrier.
- next legal analysis candidate: PR Readiness Stage 2 after explicit USER approval. Later provider/model/runtime implementation beyond PR-readiness execution, full AI Product Contract import, additional issue-resolution branches, Workspace Runtime Isolation Stage 2, Repo-Wide High-Risk Source Owner Marker Adoption, or another carrier require separate USER approval.
...
Latest Public Prerelease Publication: https://github.com/GiribaldiTTV/Nexus-Desktop-AI/releases/tag/v1.7.0-prebeta
Latest Public Prerelease Title: Pre-Beta v1.7.0
Release-Debt Avoidance Status: Existing exception - PR #129 FAM-006 Dashboard render/layout hardening, PR #132 FAM-006 Dashboard IA/control follow-through, and PR #134 FAM-007 provider-boundary / no-provider shell merged after v1.7.0-prebeta and remain unreleased implementation work; PR #129/#132 release-support remains separate and USER-gated, while release execution remains pending USER approval.
...
Runtime Branch Evidence: `feature/fam-007-provider-boundary-no-provider-shell` remains PR #134 evidence and is restored in `C:\Nexus Worktrees\FAM-007` as the FAM-007-only runtime carrier after PR #135.
...
Next Legal Analysis Candidate: PR Readiness Stage 2 after explicit USER approval. Later provider/model/runtime implementation beyond PR-readiness execution, Repo-Wide High-Risk Source Owner Marker Adoption, merge, release work, or another legal carrier requires separate USER approval.
...
Backlog Addition User Approval Missing: Cleared for USER-approved FAM-006 release-support source-truth repair merged by PR #133 and for USER-approved FAM-007 branch creation plus completed local-only SLC-017/SLC-018/SLC-031/SLC-032/SLC-033/SLC-034/SLC-035/SLC-036 scaffolds; active for runtime implementation beyond completed scaffolds, new backlog item, backlog split, full AI Product Contract import, GitHub issue work, release/tag/artifact work, PR creation, model downloads, real provider SDK integration, memory/indexing, voice/Core sync, shortcut/installer work, or any single-slice package waiver.
...
Recommended Next Workstream: FAM-007 Provider Boundary And No-Provider Shell - the current branch remains the selected Branch Readiness and future bounded Workstream carrier for consolidated PKG-007 planning.
Record State: Registry-only implementation continuation under admitted FAM-007 / PKG-007.
Minimal Scope: runtime-slice consolidated branch-material planning for admitted PKG-007 slices SLC-017, SLC-018, SLC-031, SLC-032, SLC-033, SLC-034, SLC-035, and SLC-036 plus preserved local-only scaffold evidence; no model downloads, real provider SDK integration, memory/indexing, voice/Core sync, shortcut/installer work, release/tag/artifact work, GitHub issue creation, or full AI Product Contract import is admitted by this marker.
...
Selection Scope: USER approved FAM-007 as the selected active lane in the new separate FAM-007 worktree. FAM-006 / PR #129 and PR #132 release-support truth is merged by PR #133; release execution remains USER-gated.
PR #129 / PR #132 Boundary: release-support records merged-unreleased FAM-006 Dashboard debt and closeout planning only; release execution and issue closeout remain USER-gated.
PR #134 Merge State: merged at `2c0b2ce6f602651cf85682e0fbfce3c3367cb509` with repaired head `c1b47a6b53f4286c2f60ebf5d74d9afe38dadb52`.
