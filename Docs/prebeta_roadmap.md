...
- next concern: run the final drift sweep across backlog, roadmap, branch authority, routing, and validator surfaces in Phase 6 / Slice R6-S5 while preserving the converted roadmap family-anchor framing, the split workstream index, the aligned routing/loader surfaces, the validated FB-049 selected-next lock, and branch-not-created truth.
