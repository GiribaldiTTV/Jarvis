...
Selected Next Record State: Branch-local refreshed LV1 close-guard and visual-proof repair implementation is preserved, and the interactive-control visual QA repair implementation is complete pending Hardening H1; PR #165 through PR #168 main truth remains context only.
...
Selection Scope: This branch carries FAM-006 Monitor Groups / Sensor Command Center close-guard and visual-proof repair implementation plus the interactive-control visual QA repair. PR #162 and PR #165 FAM-007 source truth is preserved as current-main context only and remains routed to the FAM-007 lane.
