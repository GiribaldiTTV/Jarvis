...
| `FAM-006` Monitoring and HUD | Dashboard, Sensor Command Center, and Overlay Profile foundation evidence are released receipts; future monitoring/HUD scope remains USER-gated | `Docs/family_visions/FAM-006_monitoring_and_hud.md` | `Docs/branch_records/feature_fam_006_overlay_profile_runtime_foundation.md` |
| `FAM-007` Local AI and Capability Packs | local-only provider setup and consent readiness sequence is released through consent collection implementation foundation in v1.7.16-prebeta via PR #201; durable consent persistence foundation Workstream, Hardening H1, Live Validation LV1, and PR Readiness Stage 1 source-truth repair are green after Seam Group A and Seam Group B implementation with Stage 2 USER gate recorded on the branch receipt; provider execution and model work remain USER-gated | `Docs/family_visions/FAM-007_local_ai_and_capability_packs.md` | `Docs/branch_records/feature_fam_007_local_ai_provider_durable_consent_persistence_foundation.md` |
