...
- current branch after `v1.7.12-prebeta` tag context: USER approved Branch Readiness Stage 2 setup for `feature/fam-006-overlay-profile-runtime-foundation` in `C:\Nexus Worktrees\FAM-006`; `feature/fam-007-local-ai-provider-consent-collection-foundation` is PR #193 current-main context, `feature/fam-007-local-ai-provider-setup-implementation-foundation` is released PR #192 context, `feature/fam-007-local-ai-provider-setup-contract-readiness` is released PR #190 context, `feature/repo-wide-source-owner-marker-adoption` is historical PR #185 evidence, PR #186 is its fold-down repair evidence, PR #187 is release-window support publication evidence, PR #191 is released release-readiness source-truth context, and `feature/fam-006-monitor-groups-sensor-configuration` is historical released PR #180 evidence.
