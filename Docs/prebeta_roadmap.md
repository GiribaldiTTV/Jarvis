...
- unreleased non-doc implementation work: none after `v1.7.13-prebeta`; provider execution, SDK/model, memory, voice/Core, shortcut/installer, issue, artifact, and future release work remains USER-gated.
...
- current active workstream: `FAM-006 Overlay Profile Runtime Foundation` on `feature/fam-006-overlay-profile-runtime-foundation`; current main includes PR #193 FAM-007 consent collection foundation as separate merged context.
- current branch after `v1.7.13-prebeta` tag context: USER approved Branch Readiness Stage 2 setup for `feature/fam-006-overlay-profile-runtime-foundation` in `C:\Nexus Worktrees\FAM-006`; `feature/fam-007-local-ai-provider-consent-collection-foundation` is released PR #193 context, `feature/fam-007-local-ai-provider-setup-implementation-foundation` is released PR #192 context, `feature/fam-007-local-ai-provider-setup-contract-readiness` is released PR #190 context, `feature/repo-wide-source-owner-marker-adoption` is historical PR #185 evidence, PR #186 is its fold-down repair evidence, PR #187 is release-window support publication evidence, PR #191 is released release-readiness source-truth context, and `feature/fam-006-monitor-groups-sensor-configuration` is historical released PR #180 evidence.
- next concern: Bounded returned-UTS Workstream implementation approval for the latest USER issue form after setup approval, SLC-041 Workstream implementation/H1 Green, prior LV1 technical proof/UTS handoff, returned USER UTS REPAIR digest, prior repair setup, returned-UTS Workstream implementation, follow-up repair setup, follow-up Workstream implementation, follow-up H1 Green, rejected refreshed LV1 technical proof/UTS handoff, bounded visual repair Workstream Green, bounded visual repair H1 Green, final refreshed LV1 technical proof PASS, Codex Visual Adjudication PASS, HUD-wide visual matrix Workstream/H1, and refreshed HUD-wide LV1 technical proof/UTS handoff. PR Readiness Stage 1, Release Readiness Stage 2, runtime/provider SDK/model execution, shortcut/installer work, AI Product Contract full import, GitHub issue creation or closeout, release/tag/artifact work, raw evidence upload/import/linking, and `codex/ai-llm-lab` mutation remain outside this setup.
...
- next legal phase: bounded returned-UTS issue Workstream implementation and H1 are Green on `feature/fam-006-overlay-profile-runtime-foundation`; refreshed LV1 / UTS recheck is the next governed action. PR Readiness Stage 1, Release Readiness Stage 2, issue work, artifacts beyond GitHub source archives, branch cleanup, provider SDK/model work, memory/indexing implementation, voice/Core runtime sync, shortcut/installer work, release, AI Product Contract import, Private Dev ORIN import, and any additional runtime branch creation require separate USER approval.
...
Runtime Package Admission: `Admitted for FAM-006 / PKG-006 successor setup; runtime behavior now includes the returned-UTS selector-first Overlay Profile Settings repair, compact Manage Monitors Assigned Overlay row, follow-up manager/filter NDAI dropdown repair, profile Delete confirmation, clickable assignment/status surface, Enabled for Overlay removal, and source-list sensor settings IA while preserving the bounded FAM-006 carrier.`
Next Legal Runtime Step: `USER UTS review for the refreshed LV1 handoff. PR Readiness remains blocked until USER returns PASS or explicit waiver with reason.`
...
Merged-Main Selected-Next Context: PR #193 merged FAM-007 consent collection foundation as current-main context; no FAM-006 successor is selected by main by inertia.
...
Next Legal Phase: Live Validation
Next Legal Phase Detail: Bounded returned-UTS issue Workstream implementation and H1 are Green on `feature/fam-006-overlay-profile-runtime-foundation`. Refreshed LV1 technical proof and formal UTS handoff are supporting historical evidence only; latest returned USER UTS remains REPAIR. PR Readiness remains blocked until refreshed LV1 and returned USER PASS or waiver with reason are recorded. Release Readiness Stage 2, release execution, issue work, artifacts beyond GitHub source archives, provider setup, consent collection, provider SDK/model work, memory/indexing/learning/personalization, voice/Core sync, shortcut/installer work, and AI Product Contract import remain separate USER decisions.
...
Runtime Implementation: SLC-037 Overlay Profile data/state foundation, SLC-038 visible selection/editing controls, SLC-039 settings-window monitor membership mapping, SLC-040 Manage Monitors Overlay Profile context, bounded SLC-041 validation/live-proof readiness, returned-UTS Overlay Profile UX/scale plus Manage Monitors overlay-context repair, follow-up Overlay Profile manager / Manage Monitors assignment / source-list settings IA repair, bounded visual acceptability repair, and refreshed LV1 proof repair are implemented and H1/LV1 Green where applicable. Historical Monitor Groups repairs, Dashboard resize/right-edge repairs, Source Filter/Polling Rate/Source Picker behavior, dirty guard behavior, focused visual proof standards, and Sensor Command Center boundaries remain preservation requirements. Prior LV1 technical proof and UTS handoff are complete, returned USER UTS review is REPAIR, prior returned-UTS repair setup/Workstream implementation, follow-up repair setup, follow-up Workstream implementation, follow-up H1, bounded visual repair, visual repair H1, final refreshed LV1 technical proof, Codex Visual Adjudication, HUD-wide visual inspection matrix Workstream/H1, refreshed HUD-wide LV1 technical proof, formal UTS handoff, mandatory screenshot/short-video governance repair, and latest refreshed LV1 technical proof at `20260521_233121_920` are complete/PASS. USER_TEST_REQUIRED blocks PR Readiness until returned USER PASS or waiver. Recording Profile runtime, tray recording controls, export/share, provider SDKs, model downloads/execution, external calls, memory/indexing implementation, voice/Core sync, shortcut/installer work, release work, AI Product Contract import, private Dev ORIN import, FAM-007 work, and GitHub issue mutation remain blocked.
...
- Selected Next Runtime Package Candidate: `FAM-006 / PKG-006 Overlay Profile Runtime Foundation`
- Selected Next Status: `SLC-041 Overlay Profile validation/live-proof readiness is Workstream and H1 Green after SLC-037 H1 Green, SLC-038 H1 Green, SLC-039 H1 Green, and SLC-040 H1 Green; returned-UTS Workstream implementation centralizes Overlay editing in Overlay Profile Settings and condenses Manage Monitors to a read-only Assigned Overlay row; follow-up returned-UTS setup, Workstream implementation, and H1 are Green for the additional Overlay Profile manager, assignment/status, Dashboard button parity, and source-list sensor settings IA repair; bounded visual repair Workstream/H1, final refreshed LV1 technical proof, Codex Visual Adjudication, HUD-wide visual inspection matrix Workstream/H1, refreshed HUD-wide LV1 technical proof, formal UTS handoff, and returned-UTS issue Workstream/H1 are PASS/Green, but latest returned USER UTS issue form remains REPAIR and PR Readiness is blocked until LV1/USER PASS or waiver`
