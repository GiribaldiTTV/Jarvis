...
- next concern: run Release Readiness RR1 reform-branch release validation now that PR Readiness PR1 is complete and green, while preserving the converted roadmap family-anchor framing, the split workstream index, the aligned routing/loader surfaces, and the validated FB-049 selected-next lock.
