...
- current phase after `v1.7.0-prebeta` publication: FAM-006 Dashboard settings-panel Branch Readiness Stage 2 is active on `feature/fam-006-dashboard-settings-panel`; this is the next runtime-focused Dashboard settings-panel carrier, not a governance-only branch. The current setup repairs post-PR #133 source-truth drift, establishes runtime branch authority, and preserves PR #129 / PR #132 merged-unreleased release debt. PR #130 and PR #131 are merged FAM-007 governance/readiness history while FAM-007 runtime/provider/model/shortcut/installer implementation remains pending USER approval.
...
Latest Public Prerelease Publication: https://github.com/GiribaldiTTV/Nexus-Desktop-AI/releases/tag/v1.7.0-prebeta
Latest Public Prerelease Title: Pre-Beta v1.7.0
Release-Debt Avoidance Status: Existing exception - PR #129 FAM-006 Dashboard render/layout hardening and PR #132 FAM-006 Dashboard IA/control follow-through merged after v1.7.0-prebeta and remain unreleased implementation work; PR #133 merged release-support source truth, while release execution remains pending USER approval.
Merged-main current active workstream: None
Current active workstream: None promoted; FAM-006 Dashboard settings-panel is active for Branch Readiness setup, post-PR #133 drift repair, and runtime-carrier authority only.
...
Selected Next Status: USER approved FAM-006 settings-panel Branch Readiness Stage 2 after PR #133 merge for post-merge source-truth drift repair and runtime-carrier setup only; runtime implementation remains pending later USER approval. PR #130, PR #131, and PR #133 are historical current-main evidence only; FAM-007 Workstream/runtime implementation remains pending later USER approval and may wait read-only in a separate assigned worktree.
...
Post-Release Truth: `v1.7.0-prebeta` is published and FAM-006 Monitoring HUD Dashboard Product Surface is released historical traceability; PR #129 and PR #132 are existing unreleased FAM-006 Dashboard issue-resolution implementation work after that release; PR #133 merged release-support source truth; FAM-007 readiness/admission is historical source-truth and runtime behavior remains pending USER approval.
...
Selection Scope: USER approved FAM-006 settings-panel as the next runtime-focused carrier after PR #133 merge. PR #130 and PR #131 preserve FAM-007 governance/readiness history only; this carrier does not admit FAM-007 runtime Workstream entry.
