...
- next concern: Bounded follow-up returned-UTS Workstream implementation for Overlay Profile manager, Manage Monitors assignment/status, and source-list sensor settings IA repair after SLC-041 Workstream implementation/H1 Green, LV1 technical proof/UTS handoff, returned USER UTS REPAIR digest, prior repair setup, returned-UTS Workstream implementation, and follow-up repair setup. H1, PR Readiness Stage 1, Release Readiness Stage 2, runtime/provider SDK/model execution, shortcut/installer work, AI Product Contract full import, GitHub issue creation or closeout, release/tag/artifact work, raw evidence upload/import/linking, and `codex/ai-llm-lab` mutation remain outside this setup.
...
Runtime Implementation: SLC-037 Overlay Profile data/state foundation, SLC-038 visible selection/editing controls, SLC-039 settings-window monitor membership mapping, SLC-040 Manage Monitors read-only Overlay Profile context, bounded SLC-041 validation/live-proof readiness, and returned-UTS Overlay Profile UX/scale plus Manage Monitors overlay-context repair are implemented. Historical Monitor Groups repairs, Dashboard resize/right-edge repairs, Source Filter/Polling Rate/Source Picker behavior, dirty guard behavior, focused visual proof standards, and Sensor Command Center boundaries remain preservation requirements. LV1 technical proof and UTS handoff are complete, returned USER UTS review is REPAIR, prior returned-UTS repair setup/Workstream implementation and follow-up repair setup are complete, and PR Readiness is blocked pending follow-up implementation/H1/refreshed LV1; Recording Profile runtime, tray recording controls, export/share, provider SDKs, model downloads/execution, external calls, memory/indexing implementation, voice/Core sync, shortcut/installer work, release work, AI Product Contract import, private Dev ORIN import, FAM-007 work, and GitHub issue mutation remain blocked.
