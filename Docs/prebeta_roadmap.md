...
| `FAM-006` Monitoring and HUD | Recording Profile Runtime Foundation is active after SLC-046 implementation and H1 green on `feature/fam-006-recording-profile-runtime-foundation`; SLC-047 selection/editing entry points are selected next pending USER implementation approval; Overlay Display Acceptance Foundation is released in `v1.7.19-prebeta` via PR #207; H1, LV1 proof refresh, USER Test Summary PASS/closed, and SLC-042 through SLC-045 are historical green; Dashboard, Sensor Command Center, and Overlay Profile foundation evidence are released receipts; historical Overlay Display Acceptance detail remains at `Docs/branch_records/feature_fam_006_overlay_display_acceptance_foundation.md`; historical Overlay Profile Runtime Foundation detail remains at `Docs/branch_records/feature_fam_006_overlay_profile_runtime_foundation.md`; tray recording, export/share, provider/model work, broad theme/skin work, and future monitoring/HUD scope remains USER-gated | `Docs/family_visions/FAM-006_monitoring_and_hud.md` | `Docs/branch_records/feature_fam_006_recording_profile_runtime_foundation.md` |
| `FAM-007` Local AI and Capability Packs | local-only provider setup and consent readiness sequence is released through user-operated consent UX foundation in v1.7.18-prebeta via PR #206; setup completion foundation is released in v1.7.20-prebeta via PR #210 with Workstream, H1, LV1, User Test Summary waiver, and AI Edition plan truth preserved; provider SDK/model execution and model work remain USER-gated | `Docs/family_visions/FAM-007_local_ai_and_capability_packs.md` | `Docs/branch_records/feature_fam_007_local_ai_provider_setup_completion_foundation.md` |
