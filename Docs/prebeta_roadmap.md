...
- current active workstream: Workstream Green and H1 Green for FAM-007 Local AI Provider Setup Implementation Foundation.
- current branch after `v1.7.11-prebeta` tag context: `feature/fam-007-local-ai-provider-setup-implementation-foundation` is the active H1 Green carrier; `feature/fam-007-local-ai-provider-setup-contract-readiness` is historical released PR #190 evidence; `feature/repo-wide-source-owner-marker-adoption` remains historical PR #185 evidence, PR #186 is its fold-down repair evidence, PR #187 is release-window support publication evidence, and `feature/fam-006-monitor-groups-sensor-configuration` is historical released PR #180 evidence.
- next concern: Live Validation LV1 for the detailed FAM-007 provider setup implementation foundation carrier. Consent collection, runtime/provider SDK/model execution, shortcut/installer work, AI Product Contract full import, GitHub issue creation or closeout, release execution, tag/artifact work, raw evidence upload/import/linking, and `codex/ai-llm-lab` mutation remain outside this Workstream.
...
- next legal phase: Live Validation LV1 for `feature/fam-007-local-ai-provider-setup-implementation-foundation`; PR creation, consent collection, release execution, issue work, artifacts beyond GitHub source archives, branch cleanup, provider SDK/model work, memory/indexing implementation, voice/Core runtime sync, shortcut/installer work, AI Product Contract import, and Private Dev ORIN import require separate USER approval.
...
Selected Next Record State: Workstream Green for a fresh FAM-007 carrier after `v1.7.11-prebeta`; PR #190 setup contract readiness is released evidence and PR #180 remains unrelated historical FAM-006 evidence.
