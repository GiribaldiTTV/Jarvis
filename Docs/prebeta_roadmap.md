...
- unreleased non-doc implementation work: None after `v1.7.4-prebeta`; PR #162 and PR #163 are released historical scope. The FAM-007 branch completed the local-only FAM-007 Local AI Runtime Contracts and Capability Foundation Workstream through SLC-036 before merge; remaining provider SDK/model/memory/voice/Core/shortcut/installer/release work remains USER-gated.
...
- current phase after `v1.7.4-prebeta` publication: no active runtime/product branch on main; PR #162 and PR #163 are released historical scope. FAM-007 provider SDK/model/shortcut/installer work remains pending USER approval.
...
- next legal phase: Branch Readiness or Waiting For USER Direction for the next approved runtime carrier. Provider SDK/model work, memory/indexing implementation, voice/Core runtime sync, shortcut/installer work, release execution, AI Product Contract import, Private Dev ORIN import, and GitHub issue creation require separate USER approval.
...
Release-Debt Avoidance Status: PR #162 and PR #163 are released in v1.7.4-prebeta; release execution and future FAM-007 runtime expansion, provider/model/memory/shortcut/installer work, Overlay acceptance, and AI Product work remain separate USER-gated decisions.
Merged-main current active workstream: None after v1.7.4-prebeta publication
...
Next Legal Analysis Candidate: Branch Readiness or Waiting For USER Direction for the next approved runtime carrier; release execution remains a separate USER decision.
...
Next Legal Phase: Branch Readiness or Waiting For USER Direction for the next approved runtime carrier; release work, issue work, provider SDK/model work, memory/indexing implementation, voice/Core runtime sync, shortcut/installer work, and AI Product Contract import remain separate USER decisions.
...
Branch: Not created after v1.7.4-prebeta publication; `feature/fam-007-local-ai-runtime-expansion` is historical released scope.
Current Carrier Branch: None after v1.7.4-prebeta publication.
Selected Next Current-Carrier Note: `feature/fam-007-local-ai-runtime-expansion` is historical released PR #162 scope, not an active carrier and not authority for any future successor.
Selection Scope: No selected-next runtime carrier after v1.7.4-prebeta publication. PR #138 remains released historical scaffold evidence in v1.7.1-prebeta, PR #152 is released historical scaffold continuation in v1.7.2-prebeta, PR #159 is released historical runtime-foundation evidence in v1.7.3-prebeta, and PR #162 plus PR #163 are released historical scope in v1.7.4-prebeta.
