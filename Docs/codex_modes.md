...
- the local USER hub `D:\Nexus Desktop AI\USER\User Test Summary.txt` file is the required user-facing exported copy when relevant, but it is not the default canonical repo record
