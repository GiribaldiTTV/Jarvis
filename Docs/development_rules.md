...
USER-facing BP1/BP2 review files must avoid technical Git packet metadata. Branch HEAD, SHA, origin/main, merge base, ZIP hash, and similar freshness values belong in `START_HERE.md`, helper output, or Codex chat digests, not in the readable branch vision or branch plan contract.
