...
- for the `Standing Governance Intake Branch`, GitHub Desktop must be bound to `D:\Nexus Desktop AI\Worktrees\Governance` before USER-driven Desktop operations so the standing branch is not confused with FAM-006, FAM-007, or the main/consolidator folder
