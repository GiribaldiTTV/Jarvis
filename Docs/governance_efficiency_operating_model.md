...
- include a `START_HERE.md` file as a plain-language index only, with `Review Purpose:`, `Temporary USER/ChatGPT Review Aid:`, `Source-Truth Fold-In:`, `Technical Proof Location:`, `Review Order`, `Exact USER Decision This Bundle Supports:`, `Pending USER Decisions`, and copied source paths
