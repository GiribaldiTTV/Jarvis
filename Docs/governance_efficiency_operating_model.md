...
- USER-facing RAR packet: `D:\Nexus Desktop AI\USER\<worktree-label>\` plus timestamped `D:\Nexus Desktop AI\USER\<worktree-label>-YYYYMMDD-HHMMSS.zip`
...
The active local USER hub is `D:\Nexus Desktop AI\USER`.

The USER review packet must:

- live under one stable local hub root, `D:\Nexus Desktop AI\USER`
