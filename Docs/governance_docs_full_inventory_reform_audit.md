...
| 10 | `Docs/branch_plans/README.md` | branch plan standard | 269 | Keep | Medium | High |
...
| 89 | `Docs/governance_efficiency_operating_model.md` | governance support standard | 349 | Keep | Medium | High |
| 90 | `Docs/governance_intake_triage_and_digest_profiles.md` | governance support standard | 163 | Keep | Medium | High |
| 91 | `Docs/governance_process_efficiency_reform_plan.md` | governance support standard | 905 | Keep | High | High |
...
| `Docs/governance_efficiency_operating_model.md` | High | `volatile-current-wording=60`; `unclear-ownership-wording=52`; `soft-commitment-wording=40`; `state-ledger-wording=65` | Clarify owner, time basis, and whether wording is historical receipt or live truth. |
...
| `Docs/governance_process_efficiency_reform_plan.md` | High | `volatile-current-wording=149`; `unclear-ownership-wording=143`; `soft-commitment-wording=65`; `state-ledger-wording=126` | Clarify owner, time basis, and whether wording is historical receipt or live truth. |
...
| `Docs/validation_helper_registry.md` | High | `volatile-current-wording=69`; `unclear-ownership-wording=50`; `soft-commitment-wording=5`; `state-ledger-wording=191` | Clarify owner, time basis, and whether wording is historical receipt or live truth. |
...
| `Docs/governance_efficiency_operating_model.md` | 349 | Governance Efficiency Operating Model | governance support standard | supporting governance standard | single-purpose governance rules and pointers | Updated in this reform branch. | None unless USER edits this dossier or a future validator flags drift. | Keep | High | Low | Yes | Yes | Yes | Covered by existing owner validator or future focused owner check. | _Add notes here._ |
...
| `Docs/governance_process_efficiency_reform_plan.md` | 905 | Governance Process Efficiency Reform Plan | governance support standard | supporting governance standard | single-purpose governance rules and pointers | Updated in this reform branch. | None unless USER edits this dossier or a future validator flags drift. | Keep | High | Low | Yes | Yes | Yes | Covered by existing owner validator or future focused owner check. | _Add notes here._ |
...
- Deletion posture: Keep; no deletion recommended in this pass..
- Ambiguity risk: High.
- Ambiguity signals: `volatile-current-wording=24`; `unclear-ownership-wording=27`; `soft-commitment-wording=8`; `state-ledger-wording=32`
- Ambiguity review action: Clarify owner, time basis, and whether wording is historical receipt or live truth.
- Structure risk: Low.
- Structure action: Structure is acceptable for current owner category.
...
- Deletion posture: Keep; no deletion recommended in this pass..
- Ambiguity risk: High.
- Ambiguity signals: `volatile-current-wording=60`; `unclear-ownership-wording=52`; `soft-commitment-wording=40`; `state-ledger-wording=65`
- Ambiguity review action: Clarify owner, time basis, and whether wording is historical receipt or live truth.
- Structure risk: Low.
- Structure action: Structure is acceptable for current owner category.
...
- Actual observed use: governance support standard with markers live=20, pr/release/issue=36, package/slice=6, branch/worktree/phase=184, validator/helper=327.
- Correct owner category: governance support standard
- What gets recorded here: supporting governance standard.
- What should be recorded here: single-purpose governance rules and pointers.
- What should move elsewhere: branch-specific blocker narrative.
...
- Deletion posture: Keep; no deletion recommended in this pass..
- Ambiguity risk: High.
- Ambiguity signals: `volatile-current-wording=149`; `unclear-ownership-wording=143`; `soft-commitment-wording=65`; `state-ledger-wording=126`
- Ambiguity review action: Clarify owner, time basis, and whether wording is historical receipt or live truth.
- Structure risk: Low.
- Structure action: Structure is acceptable for current owner category.
...
- Deletion posture: Keep; no deletion recommended in this pass..
- Ambiguity risk: High.
- Ambiguity signals: `volatile-current-wording=751`; `unclear-ownership-wording=289`; `soft-commitment-wording=172`; `state-ledger-wording=391`
- Ambiguity review action: Clarify owner, time basis, and whether wording is historical receipt or live truth.
- Structure risk: Low.
- Structure action: Structure is acceptable for current owner category.
- Duplicate fact classes found: active branch authority, current branch status, next legal phase, selected-next, worktree slot assignment, worktree live state, origin/main, PR state, merge status, latest tag/release, release receipt, release schedule outline, package trace, slice trace, issue posture, branch runtime plan, branch phase history, branch receipt, workstream durable history, family dossier continuity, validator registry, helper responsibility, phase rules, prompt/Codex mode rules, release note/public body rules.
...
- Deletion posture: Keep; no deletion recommended in this pass..
- Ambiguity risk: High.
- Ambiguity signals: `volatile-current-wording=69`; `unclear-ownership-wording=50`; `soft-commitment-wording=5`; `state-ledger-wording=191`
- Ambiguity review action: Clarify owner, time basis, and whether wording is historical receipt or live truth.
- Structure risk: Low.
- Structure action: Structure is acceptable for current owner category.
