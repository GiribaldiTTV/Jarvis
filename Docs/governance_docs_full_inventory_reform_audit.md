...
`Docs/prebeta_roadmap.md` now owns pre-Beta release sequencing, public milestone posture, and release-readiness field expectations. It derives live latest release/tag/window truth from Git/GitHub/helpers and should not maintain active release state manually.
...
- Duplicate fact classes found: active branch authority, next legal phase, selected-next, worktree live state, origin/main, PR state, merge status, latest tag/release, release receipt, release sequencing, package trace, issue posture, branch phase history, branch receipt, workstream durable history, helper responsibility, phase rules, prompt/Codex mode rules, release note/public body rules.
...
- Duplicate fact classes found: active branch authority, next legal phase, selected-next, worktree live state, origin/main, merge status, latest tag/release, release sequencing, branch phase history, branch receipt, workstream durable history, family dossier continuity, validator registry, helper responsibility, phase rules, prompt/Codex mode rules, release note/public body rules.
...
- Migration target: durable family implementation history after fold-down.
- Recommendation: Keep historical receipt.
- Duplicate fact classes found: active branch authority, next legal phase, origin/main, merge status, release sequencing, branch phase history, branch receipt, workstream durable history, helper responsibility, phase rules, prompt/Codex mode rules.
...
- Migration target: durable family implementation history after fold-down.
- Recommendation: Migrate / compact receipt.
- Duplicate fact classes found: active branch authority, current branch status, next legal phase, selected-next, worktree live state, PR state, merge status, latest tag/release, release receipt, release sequencing, package trace, slice trace, branch phase history, branch receipt, workstream durable history, helper responsibility, phase rules, prompt/Codex mode rules, release note/public body rules.
...
- Migration target: durable family implementation history after fold-down.
- Recommendation: Keep historical receipt.
- Duplicate fact classes found: active branch authority, next legal phase, selected-next, worktree live state, origin/main, PR state, merge status, latest tag/release, release sequencing, package trace, slice trace, branch phase history, branch receipt, workstream durable history, helper responsibility, phase rules, prompt/Codex mode rules, release note/public body rules.
...
- Migration target: durable family implementation history after fold-down.
- Recommendation: Keep historical receipt.
- Duplicate fact classes found: active branch authority, next legal phase, selected-next, worktree live state, PR state, merge status, latest tag/release, release receipt, release sequencing, package trace, slice trace, branch phase history, branch receipt, workstream durable history, helper responsibility, phase rules, prompt/Codex mode rules, release note/public body rules.
...
- Migration target: durable family implementation history after fold-down.
- Recommendation: Migrate / compact receipt.
- Duplicate fact classes found: active branch authority, current branch status, next legal phase, selected-next, worktree live state, PR state, merge status, latest tag/release, release receipt, release sequencing, branch phase history, branch receipt, workstream durable history, helper responsibility, phase rules, prompt/Codex mode rules, release note/public body rules.
...
- Migration target: durable family implementation history after fold-down.
- Recommendation: Keep historical receipt.
- Duplicate fact classes found: active branch authority, next legal phase, selected-next, worktree live state, origin/main, PR state, merge status, latest tag/release, release receipt, release sequencing, branch phase history, branch receipt, workstream durable history, helper responsibility, phase rules, prompt/Codex mode rules, release note/public body rules.
...
- Migration target: durable family implementation history after fold-down.
- Recommendation: Migrate / compact receipt.
- Duplicate fact classes found: active branch authority, current branch status, next legal phase, selected-next, worktree live state, origin/main, PR state, merge status, latest tag/release, release receipt, release sequencing, package trace, slice trace, issue posture, branch phase history, branch receipt, workstream durable history, helper responsibility, phase rules, prompt/Codex mode rules, release note/public body rules.
...
- Migration target: durable family implementation history after fold-down.
- Recommendation: Migrate / compact receipt.
- Duplicate fact classes found: active branch authority, current branch status, next legal phase, selected-next, worktree live state, origin/main, PR state, merge status, latest tag/release, release sequencing, package trace, slice trace, issue posture, branch phase history, branch receipt, workstream durable history, validator registry, helper responsibility, phase rules, prompt/Codex mode rules, release note/public body rules.
...
- Migration target: durable family implementation history after fold-down.
- Recommendation: Migrate / compact receipt.
- Duplicate fact classes found: active branch authority, current branch status, next legal phase, selected-next, worktree live state, origin/main, PR state, merge status, latest tag/release, release receipt, release sequencing, package trace, branch runtime plan, branch phase history, branch receipt, workstream durable history, validator registry, helper responsibility, phase rules, prompt/Codex mode rules, release note/public body rules.
...
- Migration target: durable family implementation history after fold-down.
- Recommendation: Migrate / compact receipt.
- Duplicate fact classes found: active branch authority, current branch status, next legal phase, selected-next, worktree live state, origin/main, PR state, merge status, latest tag/release, release receipt, release sequencing, package trace, slice trace, branch runtime plan, branch phase history, branch receipt, workstream durable history, validator registry, helper responsibility, phase rules, prompt/Codex mode rules, release note/public body rules.
...
- Migration target: durable family implementation history after fold-down.
- Recommendation: Keep historical receipt.
- Duplicate fact classes found: active branch authority, current branch status, next legal phase, selected-next, worktree live state, merge status, latest tag/release, release sequencing, slice trace, branch phase history, branch receipt, workstream durable history, family dossier continuity, validator registry, helper responsibility, phase rules, prompt/Codex mode rules, release note/public body rules.
...
- Migration target: durable family implementation history after fold-down.
- Recommendation: Keep historical receipt.
- Duplicate fact classes found: active branch authority, next legal phase, selected-next, worktree live state, merge status, latest tag/release, release sequencing, slice trace, branch phase history, branch receipt, workstream durable history, family dossier continuity, validator registry, helper responsibility, phase rules, release note/public body rules.
...
- Migration target: durable family implementation history after fold-down.
- Recommendation: Keep historical receipt.
- Duplicate fact classes found: active branch authority, next legal phase, worktree live state, merge status, latest tag/release, release sequencing, slice trace, branch phase history, branch receipt, workstream durable history, family dossier continuity, validator registry, helper responsibility, phase rules, prompt/Codex mode rules, release note/public body rules.
...
- Migration target: durable family implementation history after fold-down.
- Recommendation: Keep historical receipt.
- Duplicate fact classes found: active branch authority, next legal phase, selected-next, worktree live state, origin/main, PR state, merge status, latest tag/release, release sequencing, branch phase history, branch receipt, workstream durable history, helper responsibility, phase rules, prompt/Codex mode rules, release note/public body rules.
...
- Migration target: durable family implementation history after fold-down.
- Recommendation: Keep historical receipt.
- Duplicate fact classes found: active branch authority, next legal phase, selected-next, worktree live state, PR state, merge status, latest tag/release, release sequencing, branch phase history, branch receipt, workstream durable history, helper responsibility, phase rules, prompt/Codex mode rules, release note/public body rules.
...
- Migration target: durable family implementation history after fold-down.
- Recommendation: Keep historical receipt.
- Duplicate fact classes found: active branch authority, next legal phase, selected-next, worktree live state, PR state, merge status, latest tag/release, release receipt, release sequencing, branch phase history, branch receipt, workstream durable history, helper responsibility, phase rules, prompt/Codex mode rules, release note/public body rules.
...
- Duplicate fact classes found: active branch authority, current branch status, next legal phase, selected-next, worktree slot assignment, worktree live state, origin/main, PR state, merge status, latest tag/release, release sequencing, package trace, slice trace, issue posture, branch runtime plan, branch phase history, branch receipt, workstream durable history, family dossier continuity, validator registry, helper responsibility, phase rules, prompt/Codex mode rules, release note/public body rules.
...
- Recommendation: Keep.
- Duplicate fact classes found: worktree live state, merge status, latest tag/release, release receipt, release sequencing, branch receipt, workstream durable history, validator registry, helper responsibility, phase rules, prompt/Codex mode rules, release note/public body rules.
...
- Migration target: live latest-release state.
- Recommendation: Keep.
- Duplicate fact classes found: release sequencing, branch receipt, phase rules.
- Live operational truth fields found: None found.
...
- Migration target: live latest-release state.
- Recommendation: Keep.
- Duplicate fact classes found: merge status, release sequencing, branch receipt, workstream durable history, prompt/Codex mode rules, release note/public body rules.
- Live operational truth fields found: None found.
...
- Migration target: live latest-release state.
- Recommendation: Keep.
- Duplicate fact classes found: worktree live state, merge status, release sequencing, branch receipt, workstream durable history, helper responsibility, prompt/Codex mode rules, release note/public body rules.
...
- Migration target: live latest-release state.
- Recommendation: Keep.
- Duplicate fact classes found: worktree live state, release sequencing, branch receipt, workstream durable history, validator registry, helper responsibility, prompt/Codex mode rules, release note/public body rules.
- Live operational truth fields found: `- hotkey cleanup before Beta`
...
- Migration target: live latest-release state.
- Recommendation: Keep.
- Duplicate fact classes found: worktree live state, merge status, release sequencing, branch receipt, helper responsibility, prompt/Codex mode rules.
...
- Recommendation: Keep.
- Duplicate fact classes found: active branch authority, current branch status, next legal phase, selected-next, worktree slot assignment, worktree live state, origin/main, PR state, merge status, latest tag/release, release receipt, release sequencing, package trace, slice trace, branch runtime plan, branch phase history, branch receipt, workstream durable history, validator registry, helper responsibility, phase rules, prompt/Codex mode rules, release note/public body rules.
...
- Recommendation: Keep.
- Duplicate fact classes found: active branch authority, current branch status, next legal phase, selected-next, worktree slot assignment, worktree live state, origin/main, merge status, latest tag/release, release receipt, release sequencing, package trace, slice trace, branch phase history, branch receipt, workstream durable history, validator registry, helper responsibility, phase rules, prompt/Codex mode rules, release note/public body rules.
...
- Duplicate fact classes found: active branch authority, current branch status, selected-next, worktree live state, origin/main, PR state, release receipt, release sequencing, package trace, slice trace, issue posture, branch runtime plan, branch phase history, branch receipt, workstream durable history, family dossier continuity, validator registry, helper responsibility, phase rules, prompt/Codex mode rules, release note/public body rules.
...
- Migration target: branch-specific blocker narrative.
- Recommendation: Keep.
- Duplicate fact classes found: active branch authority, next legal phase, worktree slot assignment, worktree live state, origin/main, PR state, merge status, latest tag/release, release receipt, release sequencing, package trace, slice trace, branch runtime plan, branch receipt, workstream durable history, family dossier continuity, validator registry, helper responsibility, phase rules, prompt/Codex mode rules, release note/public body rules.
...
- Repetitive language found: Release/phase/branch marker repetition requires owner-pointer discipline.
- Current-state markers found: `| `Docs/orin_task_template.md` | reusable prompt skeleton fields | current live branch facts |`; `| `Docs/codex_user_guide.md` | human-readable operator guide | machine-enforced current-state authority |`; `| `Docs/feature_backlog.md` | compact feature-family registry, status, and pointer layer | detailed active-branch execution planning |`; `| `Docs/branch_records/index.md` | active/historical branch authority routing | detailed branch implementation checklists |`; `| `Docs/branch_plans/<branch>.md` | active runtime branch engineering plan, per-seam checklist, plan-to-implementation traceability | permanent family-level dossier after PR fold-d`
...
- Migration target: branch-specific blocker narrative.
- Recommendation: Keep.
- Duplicate fact classes found: active branch authority, next legal phase, selected-next, worktree slot assignment, worktree live state, origin/main, merge status, latest tag/release, release receipt, release sequencing, branch runtime plan, branch receipt, workstream durable history, validator registry, helper responsibility, phase rules, prompt/Codex mode rules, release note/public body rules.
...
- Migration target: branch-specific blocker narrative.
- Recommendation: Keep.
- Duplicate fact classes found: active branch authority, selected-next, worktree live state, origin/main, merge status, latest tag/release, release receipt, release sequencing, branch receipt, workstream durable history, validator registry, helper responsibility, phase rules, prompt/Codex mode rules, release note/public body rules.
...
- Migration target: current phase or live Git/GitHub truth.
- Recommendation: Keep.
- Duplicate fact classes found: worktree live state, merge status, release sequencing, workstream durable history, validator registry, helper responsibility, prompt/Codex mode rules.
...
- Migration target: current phase or live Git/GitHub truth.
- Recommendation: Keep.
- Duplicate fact classes found: worktree live state, merge status, release sequencing, branch receipt, workstream durable history, helper responsibility, phase rules, prompt/Codex mode rules.
...
- Migration target: current phase or live Git/GitHub truth.
- Recommendation: Keep.
- Duplicate fact classes found: active branch authority, merge status, release sequencing, branch receipt, workstream durable history, helper responsibility, phase rules, prompt/Codex mode rules, release note/public body rules.
- Live operational truth fields found: None found.
...
- Actual observed use: release sequencing posture with markers live=5, pr/release/issue=15, package/slice=5, branch/worktree/phase=22, validator/helper=13.
- Correct owner category: release sequencing posture
- What gets recorded here: release sequencing and public milestone posture.
- What should be recorded here: release stream intent and milestone pointers.
- What should move elsewhere: live latest-release state or PR windows.
- Migration target: live latest-release state or PR windows.
- Recommendation: Keep compact.
- Duplicate fact classes found: active branch authority, worktree live state, origin/main, merge status, latest tag/release, release receipt, release sequencing, package trace, slice trace, branch runtime plan, branch receipt, workstream durable history, family dossier continuity, helper responsibility, phase rules, prompt/Codex mode rules, release note/public body rules.
...
- Repetitive language found: Release/phase/branch marker repetition requires owner-pointer discipline.
- Current-state markers found: `<!-- NEXUS-SOURCE-OWNER: schema=source-owner-v1; owner=SHARED-DOCS; ledger=SRCOWN-FIRSTPASS-DOCS-011; surface=compact-current-state-owner; status=shared -->`; `This file does not own live latest-release state, live tag state, active branch state, open PR state, current review state, worktree freshness, or release-window inventories. Those`; `- latest public prerelease as manually maintained active truth`; `- current `origin/main`, release target commit, or tag commit`; `- merged-unreleased PR lists as active truth`
...
- Actual observed use: validator/helper registry with markers live=45, pr/release/issue=26, package/slice=8, branch/worktree/phase=173, validator/helper=487.
...
- Duplicate fact classes found: next legal phase, selected-next, worktree live state, PR state, merge status, latest tag/release, release sequencing, branch phase history, branch receipt, workstream durable history, validator registry, helper responsibility, phase rules, prompt/Codex mode rules, release note/public body rules.
...
- Migration target: volatile Git/GitHub live facts.
- Recommendation: Keep / normalize durable history.
- Duplicate fact classes found: active branch authority, current branch status, next legal phase, selected-next, worktree live state, PR state, merge status, latest tag/release, release receipt, release sequencing, slice trace, branch phase history, branch receipt, workstream durable history, validator registry, helper responsibility, phase rules, prompt/Codex mode rules, release note/public body rules.
...
- Migration target: volatile Git/GitHub live facts.
- Recommendation: Keep / normalize durable history.
- Duplicate fact classes found: release sequencing, branch receipt, workstream durable history.
- Live operational truth fields found: None found.
...
- Migration target: volatile Git/GitHub live facts.
- Recommendation: Keep / normalize durable history.
- Duplicate fact classes found: active branch authority, next legal phase, selected-next, worktree live state, PR state, merge status, release receipt, release sequencing, slice trace, branch phase history, branch receipt, workstream durable history, family dossier continuity, helper responsibility, phase rules, prompt/Codex mode rules.
...
- Migration target: volatile Git/GitHub live facts.
- Recommendation: Keep / normalize durable history.
- Duplicate fact classes found: worktree live state, release sequencing, branch receipt, workstream durable history.
...
- Migration target: volatile Git/GitHub live facts.
- Recommendation: Keep / normalize durable history.
- Duplicate fact classes found: active branch authority, current branch status, next legal phase, selected-next, worktree live state, PR state, merge status, latest tag/release, release sequencing, branch phase history, branch receipt, workstream durable history, validator registry, helper responsibility, phase rules, prompt/Codex mode rules, release note/public body rules.
...
- Migration target: volatile Git/GitHub live facts.
- Recommendation: Keep / normalize durable history.
- Duplicate fact classes found: active branch authority, next legal phase, selected-next, worktree live state, origin/main, PR state, merge status, latest tag/release, release sequencing, slice trace, branch phase history, branch receipt, workstream durable history, validator registry, helper responsibility, phase rules, prompt/Codex mode rules, release note/public body rules.
...
- Migration target: volatile Git/GitHub live facts.
- Recommendation: Keep / normalize durable history.
- Duplicate fact classes found: release sequencing, branch receipt, workstream durable history, phase rules.
- Live operational truth fields found: None found.
...
- Migration target: volatile Git/GitHub live facts.
- Recommendation: Keep / normalize durable history.
- Duplicate fact classes found: latest tag/release, release sequencing, branch receipt, workstream durable history, helper responsibility, phase rules, release note/public body rules.
- Live operational truth fields found: None found.
...
- Migration target: volatile Git/GitHub live facts.
- Recommendation: Keep / normalize durable history.
- Duplicate fact classes found: current branch status, worktree live state, merge status, release sequencing, branch phase history, branch receipt, workstream durable history, family dossier continuity, validator registry, helper responsibility, phase rules, prompt/Codex mode rules.
...
- Migration target: volatile Git/GitHub live facts.
- Recommendation: Keep / normalize durable history.
- Duplicate fact classes found: active branch authority, next legal phase, worktree live state, origin/main, merge status, release sequencing, branch phase history, branch receipt, workstream durable history, family dossier continuity, validator registry, helper responsibility, phase rules, prompt/Codex mode rules, release note/public body rules.
...
- Migration target: volatile Git/GitHub live facts.
- Recommendation: Keep / normalize durable history.
- Duplicate fact classes found: active branch authority, current branch status, merge status, latest tag/release, release sequencing, branch receipt, workstream durable history, family dossier continuity, helper responsibility, phase rules, prompt/Codex mode rules, release note/public body rules.
- Live operational truth fields found: None found.
- Governance receipt fields found: `## Historical Pass Record Identity`; `- Backlog Registry Class: `Historical Pass Alias``; `- Historical Alias Of: `FB-027``; `- Alias Role: `Historical Pass Record``; `- Converted By Seam: `Phase 5 - Historical Pass Record Conversion / Slice R5-S2 - Convert FB-036, FB-037, FB-038, and FB-041 workstream records``
- Repetitive language found: No major repetitive language flagged by scanner.
...
- Migration target: volatile Git/GitHub live facts.
- Recommendation: Keep / normalize durable history.
- Duplicate fact classes found: active branch authority, next legal phase, selected-next, worktree live state, PR state, merge status, latest tag/release, release receipt, release sequencing, slice trace, branch phase history, branch receipt, workstream durable history, validator registry, helper responsibility, phase rules, prompt/Codex mode rules, release note/public body rules.
...
- Migration target: volatile Git/GitHub live facts.
- Recommendation: Keep / normalize durable history.
- Duplicate fact classes found: active branch authority, next legal phase, selected-next, worktree live state, PR state, merge status, latest tag/release, release receipt, release sequencing, package trace, branch phase history, branch receipt, workstream durable history, family dossier continuity, validator registry, helper responsibility, phase rules, prompt/Codex mode rules, release note/public body rules.
