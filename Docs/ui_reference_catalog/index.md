...
| `UIREF-002` | `Nexus Compact Window Control Cluster` | `Window Control Cluster` | FAM-002 / F2-FF01 | `Docs/ui_reference_catalog/UIREF-002_window_control_cluster.md` | `PROMOTED_WITH_KNOWN_LIMITATIONS` | Package A green; consuming branches still prove applicable control states. |
| `UIREF-003` | `Nexus Control State And Selector Grammar` | `Button / Control State` | FAM-002 / F2-FF01 | `Docs/ui_reference_catalog/UIREF-003_control_state_and_selector_grammar.md` | `PROMOTED_WITH_KNOWN_LIMITATIONS` | Package B green; dropdown/menu/list/filter states remain branch-proof obligations. |
