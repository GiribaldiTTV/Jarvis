...
Engineering Plan Status: `BP1 USER Branch Vision, BP2 USER Branch Plan, and BP3 Workstream Entry / Orchestration Validation were accepted or approved for the prior HUD Overlay card recording launcher/preview route. USER Live Validation feedback on 2026-06-02 changes the active design direction: recording should move to its own Dashboard Recording card and not live inside the HUD Overlay card. The prior SLC-051 through SLC-055 implementation, H1, and LV1 proof remain durable evidence for the superseded route, but active phase advancement is blocked until BP1/BP2/BP3 are revised or explicitly waived for the Dashboard Recording card direction.`
...
Status: `Active Live Validation USER feedback receipt for the FAM-006 active-overlay recording runtime implementation carrier. This record admits branch authority, preserves the prior SLC-051 through SLC-055 Workstream/H1/LV1 proof as durable evidence for the superseded HUD Overlay card route, and records a blocking USER Feedback Disposition item requiring BP1/BP2/BP3 revision before any runtime repair or Live Validation continuation. Recording execution, file writing, real Start/Stop controls, tray controls, export/share, provider/model work, broad theme/skin work, FAM-007 work, Governance mutation, issue mutation, PR creation, merge, release execution, branch/worktree cleanup, and sibling-worktree mutation remain outside this feedback-routing pass.`
...
Phase Detail: `Live Validation LV1 proof/handoff remains durable evidence for the prior accepted route, but USER Live Validation feedback on 2026-06-02 changes the user-facing recording-card placement. PR Readiness is not legal; the next legal route is Branch Planning revision beginning with BP1 Branch Vision amendment, then BP2 Branch Plan revision, then BP3 Workstream Entry / Orchestration Validation before any code repair or renewed Live Validation.`
...
USER Vision Questions: `USER accepted the prior active-overlay recording contract, then revised the user-facing surface during Live Validation: recording should move to its own Dashboard card. BP1 must now ask USER to accept, revise, waive, reject, or hold this Dashboard Recording card vision before BP2 and BP3 can define the repair route.`
USER/ChatGPT Review Checkpoint: `The returned USER feedback is meaningful and blocks direct LV continuation. The active next USER decision is BP1 Branch Vision amendment for the Dashboard Recording card direction. BP2/BP3, Workstream repair, Hardening, renewed Live Validation, PR Readiness, recording execution, file writing, real Start/Stop, tray/export/provider work, and release remain future-gated.`
...
Current Branch vs Future Package Boundaries: `Current branch is the runtime implementation carrier, but active advancement is blocked by returned USER Live Validation feedback. SLC-051 target/session truth remains accepted evidence; SLC-052 HUD launcher/preview and SLC-053 Recording Control window foundation are superseded as active placement direction until BP1/BP2/BP3 revision accepts or waives a repair route. Actual recording execution, file writing, real Start/Stop, tray controls, export/share, provider/model work, broad theme/skin work, FAM-007 work, PR creation, merge, release, issue mutation, and artifacts/raw evidence handling remain future-gated.`
...
Codex Additional Recommendations: `Recommendation A: preserve SLC-051 as useful target/session truth evidence. Recommendation B: route to BP1 Branch Vision amendment for the Dashboard Recording card direction before BP2/BP3 revision. Alternative: USER may revise, waive, reject, or hold the amendment before any runtime repair.`
...
USER Decision Ledger: `USER approved Stage 2 setup, current-main reconciliation, BP1 acceptance, BP2 acceptance, BP3 approval, bounded SLC-051 through SLC-055 implementation, Hardening H1, and Live Validation LV1 for the prior active-overlay recording route. USER returned Live Validation feedback on 2026-06-02 revising the active recording surface direction: recording should move to a dedicated Dashboard Recording card and should not live inside the HUD Overlay card. Pending USER decisions now include BP1 amendment acceptance/revision/waiver/rejection/hold, BP2 revision, BP3 revision, Workstream repair, renewed Hardening, renewed Live Validation, runtime recording execution, file writing, real Start/Stop controls, tray controls, export/share, provider/model work, artifacts/raw evidence handling beyond approved USER review materials, sibling-worktree mutation, old branch cleanup/deletion, FAM-007 work, PR creation, merge, release, issue mutation, and Governance mutation.`
...
Open Questions / USER Decision Points: `The active USER decision is whether to accept, revise, waive, reject, or hold the BP1 Branch Vision amendment that moves recording to a dedicated Dashboard Recording card. Later USER decisions remain for BP2, BP3, Workstream repair, Hardening, renewed Live Validation, PR Readiness, recording execution, output-file creation, advanced Recording card or secondary-window settings, any deviation from accepted snapshot-at-start behavior, and whether per-overlay effective polling policy stays future planning or receives a later explicit branch.`
...
Status: Blocking
Fold-Down Target: BP1 amendment, BP2 revision, BP3 revision, then runtime repair only after USER approval.
Pointer Locations: Active branch record, active branch plan, family vision, and USER review packet.
No-Action Reason: Not Applicable - BP1/BP2/BP3 revision is required.
...
User-Facing Runtime Delta: `Pending BP1/BP2/BP3 revision. The future user-facing direction is a dedicated Dashboard Recording card; HUD Overlay should remain overlay-focused.`
...
Recommendations And Alternatives: `Recommend BP1 amendment acceptance for the Dashboard Recording card direction, then BP2/BP3 revision before any runtime repair.`
...
Package Admission State: `Implementation carrier admitted / UFD-FAM006-20260602-001 blocking / BP1-BP2-BP3 revision required / prior SLC-051 through SLC-055, H1, and LV1 proof preserved as superseded-route evidence`
Admitted Slice Count: `5`
Package Completion State: `Blocked for active advancement by returned USER design feedback / BP1 amendment pending / BP2-BP3 revision pending`
...
| `SLC-052` Dashboard Recording card placement revision | Revision required | Prior HUD Overlay card preview/launcher is superseded as active placement; BP2 must remap target/status and future controls to the Dashboard Recording card. | Pending BP1/BP2/BP3 revision |
| `SLC-053` Recording Control / secondary surface decision | Revision required | Prior standalone Recording Control foundation is durable evidence only; BP2 must decide whether any standalone or secondary surface remains future/secondary. | Pending BP1/BP2/BP3 revision |
...
Remaining Implementable Work: `Pending BP1/BP2/BP3 revision for Dashboard Recording card repair`
...
Continuation Execution Latch: `Inactive - returned USER design feedback requires BP1/BP2/BP3 revision before repair or PR Readiness.`

Stop Basis: `UFD-FAM006-20260602-001 / Branch Planning revision required`

Next Active Seam: BP1 Branch Vision amendment - Dashboard Recording card design revision

Stop Condition: `Met - returned USER design feedback blocks active advancement until Branch Planning revision.`

Continuation Action: `Stop at Branch Planning revision gate; do not enter runtime repair, PR Readiness, release posture, runtime recording execution, or cleanup before BP1/BP2/BP3 revision is accepted or waived.`
...
Recommended Stage 2 Carrier Action: `Route this implementation carrier through BP1/BP2/BP3 revision for the Dashboard Recording card direction; do not enter PR Readiness or release posture before the revised route is accepted or waived, repaired if needed, hardened, live-validated, and digested.`
...
Active Blockers: `UFD-FAM006-20260602-001 - BP1/BP2/BP3 revision required for Dashboard Recording card placement`. No current-main reconciliation blocker remains after reconciliation to origin/main@9b64ac1b4faf4d29033e3a8f299a1293eb26f2d7. Prior SLC-051 target/session truth, SLC-052 HUD Overlay target preview, SLC-053 standalone Recording Control window foundation, SLC-054 durable output contract schema/readback proof, SLC-055 validation/live proof readiness, H1, and LV1 proof/handoff remain durable evidence for the superseded accepted route. The returned USER design feedback blocks PR Readiness and runtime/LV continuation until BP1/BP2/BP3 are revised or explicitly waived.
PR Readiness Boundary: PR Readiness is not reached for this active implementation carrier. BP1/BP2/BP3 revision, Workstream repair, renewed Hardening, renewed Live Validation, PR Readiness, release execution beyond already published v1.7.25-prebeta, issue mutation, artifacts/raw evidence handling beyond approved USER review materials, sibling-worktree mutation, old branch cleanup/deletion, tray recording controls, recording execution, file writing, real Start/Stop controls, export/share, provider/model work, broad theme/skin work, FAM-007 work, durable Native Log Loader implementation/source-truth mutation beyond future planning, per-overlay effective polling policy implementation, and Governance worktree mutation remain outside this feedback-routing pass.

## Exit Criteria

Exit Criteria: `UFD-FAM006-20260602-001 is not closed until USER accepts, revises, waives, rejects, or holds the BP1 amendment and the legal BP2/BP3 route is recorded. Prior SLC-051 through SLC-055, H1, and LV1 proof remain superseded-route evidence, not PR Readiness authority.`
...
Package Status: `Prior Workstream/H1/LV1 proof preserved as superseded-route evidence; UFD-FAM006-20260602-001 requires BP1/BP2/BP3 revision.`
Next Active Seam: BP1 Branch Vision amendment - Dashboard Recording card design revision
...
LV1 Result: `Prior LV1 proof/handoff remains durable evidence; returned USER design feedback now blocks active advancement pending BP1/BP2/BP3 revision.`
...
User Test Summary Returned Results: `Returned USER design feedback received; UFD-FAM006-20260602-001 blocks phase advancement pending Branch Planning revision`
...
LV1 Handoff Disposition: `Returned USER feedback changes user-facing card placement; waiting for BP1/BP2/BP3 revision before renewed LV continuation.`

## Next Legal Phase

Next Legal Phase: `Branch Planning`
Next Legal Phase Detail: `Returned USER Live Validation feedback changes the accepted user-facing recording placement from HUD Overlay card to a dedicated Dashboard Recording card. The next legal action is BP1 Branch Vision amendment review, followed by BP2 Branch Plan revision and BP3 Workstream Entry / Orchestration Validation if USER accepts or waives BP1. No Workstream repair, renewed Hardening, renewed Live Validation, PR Readiness, FAM-007 mutation, runtime recording execution, file writing, release, merge, issue mutation, or cleanup is authorized here.`
...
Next Legal Phase: `Branch Planning`
Why This Phase Is Next: `Returned USER Live Validation feedback changes the accepted BP1 surface model and BP2/BP3 proof route: recording should move to its own Dashboard Recording card instead of living inside the HUD Overlay card. The old Workstream/H1/LV1 evidence cannot be used for PR Readiness until this design revision is accepted, revised, waived, rejected, or held and the legal repair route is recorded.`
Approval Required: `USER must accept, revise, waive, reject, or hold the BP1 Branch Vision amendment before BP2/BP3 revision or runtime repair. Cleanup, issue mutation, release execution beyond already published v1.7.25-prebeta, recording execution, file writing, Start/Stop, tray/export/provider/model work remain outside this feedback-routing pass.`
Exact USER Approval Text: `I accept the FAM-006 BP1 Branch Vision amendment on feature/fam-006-active-overlay-recording-runtime-implementation in C:\Nexus Worktrees\FAM-006: recording target/status and future recording controls should move to a dedicated Dashboard Recording card, the HUD Overlay card should remain overlay-focused, active Overlay Profile membership remains the recording target source, snapshot-at-recording-start remains the future execution default, hidden target state and separate Recording Profile remain rejected, and BP2/BP3 must be revised before any runtime repair or Live Validation continuation.`
Allowed Scope: `BP1 amendment decision only; no BP2/BP3 generation, Workstream repair, PR Readiness, release, recording execution, file writing, Start/Stop, tray/export/provider/model, FAM-007, Governance, or cleanup mutation without separate authority.`
...
USER Plan Review Gate: `BP1 amendment is pending USER decision. Prior BP3 approval remains superseded-route evidence only; later repair seams are not queued until BP1/BP2/BP3 are revised or waived.`
...
Implementation Blocker: `UFD-FAM006-20260602-001 blocks implementation continuation. The prior SLC-051 through SLC-055, H1, and LV1 proof/handoff remain durable evidence for the superseded route, but USER feedback changes the recording-card placement. Recording execution, file writing, real Start/Stop controls, tray/export/provider/model work, PR, merge, release, issue mutation, and cleanup remain outside this feedback-routing pass.`
...
Active seam: `Branch Planning - BP1 amendment for Dashboard Recording card design revision`
