...
- Active Cycle Identity: `RRI-20260525-002 originates from USER-approved governance repair after Workstream Entry review clarified that USER needs a plain-language branch plan review before implementation, then exposed stale zip risk in USER review bundles. Repair scope is USER Branch Plan Review Gate source truth, task template fields, validator source-checking, fixture regression coverage, Desktop review-bundle refresh, and stable zip stale-guard hardening.`
