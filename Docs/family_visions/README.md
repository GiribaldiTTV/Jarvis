...
Deferred Feature Carryforward must avoid active branch-state terms such as `active`, `current branch`, `selected next`, `pending PR`, `in progress`, `next branch`, or `release window status`. Those terms belong to BR2 output, active external branch planning, `D:\Nexus Desktop AI Data\Governance State`, Git/GitHub/helper-derived truth, or USER decision packets.
...
Dependency candidates must avoid active branch-state terms such as `active`, `current branch`, `selected next`, `pending PR`, `in progress`, `next branch`, or `release window status`. Those terms belong to BR2 output, active external branch planning, `D:\Nexus Desktop AI Data\Governance State`, Git/GitHub/helper-derived truth, or USER decision packets.
...
- Active branch vision snapshot: `D:\Nexus Desktop AI Data\Governance State\branches\<branch_slug>\branch_plan.md`
