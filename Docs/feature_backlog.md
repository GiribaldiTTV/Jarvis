...
| `FAM-006` | Monitoring and HUD | High | Open / Recording Profile Runtime Foundation LV1 helper proof green after SLC-046 implementation/H1 green, SLC-047 selection/editing implementation/H1 green, SLC-048 relationship/boundary implementation/H1 green, SLC-049 Dashboard / Manage Monitors status integration implementation/package H1 green, SLC-050 Workstream readiness proof/package H1 green, and bounded LV1 real-input desktop proof; User Test Summary Results Pending blocks final LV1 green and PR Readiness; USER clarified future recording vision is active-overlay-driven rather than profile-loaded; Overlay Display Acceptance Foundation released in `v1.7.19-prebeta` via PR #207 remains historical green | `PKG-006` Recording Profile Runtime Foundation SLC-046 through SLC-050 Workstream and H1 are complete as foundation evidence; future actual recording runtime must reconcile/retire/hide profile-loaded direction and instead record the active Overlay Profile membership with lightweight HUD Overlay Start/Stop and standalone Recording Settings; LV1 helper proof is green; User Test Summary return/digest is pending; recording execution, output file writing, export/share, provider/model work, broad theme/skin work, FAM-007 work, PR creation, merge, release, issue mutation, artifacts/raw evidence handling beyond approved LV1 proof, and sibling-worktree mutation remain USER-gated | `Docs/family_visions/FAM-006_monitoring_and_hud.md` | `Docs/branch_records/feature_fam_006_recording_profile_runtime_foundation.md` |
| `FAM-007` | Local AI and Capability Packs | High | Open / package admitted; setup completion foundation released in v1.7.20-prebeta via PR #210 with PR #211 release-readiness fold-down evidence; AI Edition Public Leak-Prevention Foundation merged in PR #215 and is merged-unreleased release-window evidence after v1.7.21-prebeta with no-visible-runtime-surface User Test Summary waiver; Owner private repo and off-boot AI data backup/recovery remain explicit USER Action Gates; provider SDK/model execution and model work remain USER-gated | `PKG-007` admitted / not package-complete | `Docs/family_visions/FAM-007_local_ai_and_capability_packs.md` | `Docs/branch_records/feature_fam_007_ai_edition_public_leak_prevention_foundation.md` |
...
Status: Open / Recording Profile Runtime Foundation active in Branch Readiness Stage 2 setup; Overlay Display Acceptance Foundation released in `v1.7.19-prebeta` via PR #207 remains historical green; released Dashboard, Sensor Command Center, and Overlay Profile Runtime Foundation evidence preserved
Record State: Registry-only
Registry Class: Feature Family
Family Anchor: Self
Priority: High
...
Package Summary: `PKG-006` Recording Profile Runtime Foundation planning is admitted on `feature/fam-006-recording-profile-runtime-foundation`; Overlay Display Acceptance Foundation is released `v1.7.19-prebeta` / PR #207 evidence, while detailed Monitor Groups, Sensor Library, Overlay Profile, returned USER UTS, interactive-control visual QA, right-edge resize rediscovery, visual proof, Warning Notifications, Provider Readiness, and Sensor Command Center history live in FAM-006 branch authority records and related workstream evidence.
Package Admission State: Active Branch Readiness setup / runtime implementation pending Workstream Entry
Admitted Slice Count: 5 planned slices in `Docs/branch_plans/feature_fam_006_recording_profile_runtime_foundation.md`
Package Completion State: Not started
Single-Slice Package User Approval: Not required - no active single-slice package is admitted; future package admission must have multiple concrete admitted slices or USER waiver.
Canonical Detail Owner: `Docs/branch_records/feature_fam_006_recording_profile_runtime_foundation.md`
Family Vision Owner: `Docs/family_visions/FAM-006_monitoring_and_hud.md`
Historical Trace Coverage: `FB-040`, HUD surface gap, PR #118, PR #180, PR #194, PR #207, PR #212, FAM-006 branch records. Historical Overlay Profile Runtime Foundation detail remains at `Docs/branch_records/feature_fam_006_overlay_profile_runtime_foundation.md`; historical Overlay Display Acceptance detail remains at `Docs/branch_records/feature_fam_006_overlay_display_acceptance_foundation.md`.

### [ID: FAM-007] Local AI and Capability Packs

Status: Open / package admitted; consent collection implementation foundation is released in v1.7.16-prebeta via PR #201; durable consent persistence foundation is released in v1.7.17-prebeta via PR #203; user-operated consent UX foundation is released in v1.7.18-prebeta via PR #206; setup completion foundation is released in v1.7.20-prebeta via PR #210 with PR #211 release-readiness fold-down evidence; AI Edition Public Leak-Prevention Foundation merged in PR #215 and is merged-unreleased release-window evidence after v1.7.21-prebeta with no-visible-runtime-surface User Test Summary waiver; future Dev/Owner skeletons, off-boot AI data backup/recovery implementation, provider/model execution, and release execution remain USER-gated
Record State: Registry-only
Registry Class: Feature Family
Family Anchor: Self
Priority: High
...
Canonical Detail Owner: `Docs/branch_records/feature_fam_007_local_ai_provider_setup_completion_foundation.md`
...
Historical Trace Coverage: FAM-007 branch records, PR #138, PR #152, PR #159, PR #162, PR #165, PR #170, PR #172, PR #177, PR #179, PR #190, PR #192, PR #193, released PR #201 posture for `feature/fam-007-local-ai-provider-consent-collection-implementation-foundation`, released PR #203 posture for `feature/fam-007-local-ai-provider-durable-consent-persistence-foundation`, released PR #206 posture for `feature/fam-007-local-ai-provider-user-operated-consent-ux-foundation`, released PR #210 posture for `feature/fam-007-local-ai-provider-setup-completion-foundation`, and merged-unreleased PR #215 posture for `feature/fam-007-ai-edition-public-leak-prevention-foundation`.
