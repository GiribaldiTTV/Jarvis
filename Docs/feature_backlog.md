...
Status: Open / package admitted; consent collection implementation foundation is released in v1.7.16-prebeta via PR #201; durable consent persistence foundation Workstream is active with Seam Group A implemented and Seam Group B pending USER approval
Record State: Registry-only
Registry Class: Feature Family
Family Anchor: Self
Priority: High
