...
Published Release Pending Canon Closure: v1.7.13-prebeta
...
Merged-Unreleased PRs: PR #193 `FAM-007 Local AI Provider Consent Collection Foundation` is merged current-main context after `v1.7.12-prebeta`; PR #192 `FAM-007 Local AI Provider Setup Implementation Foundation` is published in `v1.7.12-prebeta`.
...
Current-branch clarity: Git/GitHub published `v1.7.12-prebeta`; release-dependent source-truth closure is carried into `feature/fam-006-overlay-profile-runtime-foundation`; PR #179, PR #180, and PR #181 are released/current-main release-window/source-truth context for `v1.7.9-prebeta`; PR #182 through PR #187 are published source-truth/dev-tooling support in `v1.7.10-prebeta`; PR #188 through PR #191 are released in `v1.7.11-prebeta`; PR #192 is released in `v1.7.12-prebeta`; PR #193 merged FAM-007 consent collection foundation as current-main context; USER approved the FAM-006 Overlay Profile Runtime Foundation successor setup; later provider setup/model implementation beyond admitted FAM-007 context, branch cleanup, release work, and additional branches remain USER-gated.
