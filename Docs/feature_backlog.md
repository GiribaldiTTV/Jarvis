...
Next Legal Runtime Step: `Hardening H1 for the follow-up returned-UTS Overlay Profile manager, Manage Monitors assignment/status, and source-list sensor settings IA repair.`
...
Selected Next Workstream: `FAM-006 Overlay Profile Runtime Foundation`.
Selected Next Runtime Package Candidate: `FAM-006 / PKG-006 Overlay Profile Runtime Foundation`.
Selected Next Status: SLC-041 Overlay Profile validation/live-proof readiness is Workstream and H1 Green after SLC-037 H1 Green, SLC-038 H1 Green, SLC-039 H1 Green, and SLC-040 H1 Green; returned-UTS Workstream implementation centralizes Overlay editing in Overlay Profile Settings and condenses Manage Monitors to an Assigned Overlay row; follow-up returned-UTS Workstream implementation adds NDAI manager/filter dropdowns, explicit Create/Edit/select workflow, profile Delete confirmation, clickable assignment/status, Enabled for Overlay removal, and source-list sensor settings IA; Live Validation LV1 technical proof and UTS handoff are complete, returned USER UTS review is REPAIR, and PR Readiness is blocked pending follow-up H1/refreshed LV1.
Selected Next Implementation Branch: `feature/fam-006-overlay-profile-runtime-foundation`.
...
Active Branch Authority Record: `Docs/branch_records/feature_fam_006_overlay_profile_runtime_foundation.md`
Historical Branch Authority Record: `Docs/branch_records/feature_fam_006_monitor_groups_sensor_configuration.md`
Next Legal Runtime Step: Hardening H1 for the follow-up returned-UTS Overlay Profile manager, Manage Monitors assignment/status, and source-list sensor settings IA repair on `feature/fam-006-overlay-profile-runtime-foundation`. Later runtime seams require separate USER approval.
