...
| `FAM-006` | Monitoring and HUD | High | Open / Active Overlay Recording Runtime Foundation Branch Readiness Stage 2 setup; prior Recording Profile Runtime Foundation Workstream rolled back by USER request; Overlay Display Acceptance Foundation released in `v1.7.19-prebeta` via PR #207 remains historical green | `PKG-006` Active Overlay Recording Runtime Foundation is admitted for Workstream Entry analysis across SLC-051 through SLC-055; future actual recording runtime must record active Overlay Profile membership with lightweight HUD Overlay Start/Stop and standalone Recording Settings after Workstream and implementation approval; recording execution, output file writing, tray controls, export/share, provider/model work, broad theme/skin work, FAM-007 work, PR creation, merge, release, issue mutation, artifacts/raw evidence handling beyond approved review bundles, old branch cleanup/deletion, and sibling-worktree mutation remain USER-gated | `Docs/family_visions/FAM-006_monitoring_and_hud.md` | `Docs/branch_records/feature_fam_006_active_overlay_recording_runtime_foundation.md` |
| `FAM-007` | Local AI and Capability Packs | High | Open / package admitted; setup completion foundation released in v1.7.20-prebeta via PR #210 with PR #211 release-readiness fold-down evidence; AI Edition Public Leak-Prevention Foundation released in v1.7.22-prebeta via PR #215 with PR #216 release-readiness guard evidence; Dev/Owner Skeleton Readiness Foundation merged in PR #218 and is merged-unreleased Breakpoint 2 public-safe action-gate evidence until release execution; Owner private repo and off-boot AI data backup/recovery remain explicit USER Action Gates; provider SDK/model execution and model work remain USER-gated | `PKG-007` admitted / not package-complete | `Docs/family_visions/FAM-007_local_ai_and_capability_packs.md` | `Docs/branch_records/feature_fam_007_ai_edition_dev_owner_skeleton_readiness_foundation.md` |
...
Status: Open / package admitted; consent collection implementation foundation is released in v1.7.16-prebeta via PR #201; durable consent persistence foundation is released in v1.7.17-prebeta via PR #203; user-operated consent UX foundation is released in v1.7.18-prebeta via PR #206; setup completion foundation is released in v1.7.20-prebeta via PR #210 with PR #211 release-readiness fold-down evidence; AI Edition Public Leak-Prevention Foundation is released in v1.7.22-prebeta via PR #215 with PR #216 release-readiness guard evidence; Dev/Owner Skeleton Readiness Foundation merged in PR #218 and is merged-unreleased Breakpoint 2 public-safe action-gate planning/proof until release execution; future private Dev/Owner skeleton implementation, off-boot AI data backup/recovery implementation, provider/model execution, and release execution remain USER-gated
Record State: Registry-only
Registry Class: Feature Family
Family Anchor: Self
Priority: High
...
Minimal Scope: `runtime slice - USER-gated FAM-007 / PKG-007 private Dev and Nexus Desktop AI Owner skeleton continuation covering private root/repo action gates, off-boot AI data backup/recovery implementation planning, public-to-private separation, Public-to-Dev import gating, provider/model execution deferral, and future handoff criteria; the current post-release canon-closure Branch Readiness carrier is feature/fam-007-v1-7-23-post-release-canon-closure at origin/main.`
Selected Next Implementation Branch: `feature/fam-007-v1-7-23-post-release-canon-closure`
Repair-Only Branch Handling: `feature/fam-007-v1-7-23-post-release-canon-closure is repair-only post-release canon-closure context and does not imply Branch Readiness admission or active branch truth for this FAM-006 current-main reconciliation; runtime implementation remains pending separate USER approval.`
