...
Selected Next Status: FAM-006 PR Readiness is blocked pending refreshed LV1/UTS PASS or explicit USER waiver with reason after green H1 for the interactive-control reliability/visual-affordance repair.
...
Next Legal Runtime Step: Refreshed LV1 / UTS recheck for the H1-repaired FAM-006 interactive-control reliability and visual-affordance repair after USER approval.
Next Legal Analysis Candidate: Refreshed LV1 / UTS recheck; PR creation, merge, release work, issue mutation, FAM-007 work, and provider/model/runtime expansion remain separate USER decisions.
