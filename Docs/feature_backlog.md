...
| `FAM-006` | Monitoring and HUD | High | Open / Recording Profile Runtime Foundation active after SLC-046 implementation/H1 green, SLC-047 selection/editing implementation/H1 green, and SLC-048 relationship/boundary implementation/H1 green; Overlay Display Acceptance Foundation released in `v1.7.19-prebeta` via PR #207 remains historical green | `PKG-006` Recording Profile Runtime Foundation SLC-046 state/data foundation implemented and H1 green; SLC-047 visible selector/editing entry points implemented and H1 green after bounded delete-control proof repair; SLC-048 state-only relationship mapping/boundary proof implemented and H1 green; SLC-049 through SLC-050 pending USER decisions | `Docs/family_visions/FAM-006_monitoring_and_hud.md` | `Docs/branch_records/feature_fam_006_recording_profile_runtime_foundation.md` |
