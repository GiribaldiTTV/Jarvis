...
- FB-030 is the selected promoted runtime follow-through lane on `feature/fb-030-voice-audio-runtime-branch-readiness`; its historical `v1.6.5-prebeta` planning proof remains preserved, and Workstream WS1 now completes the bounded voice/audio runtime availability and truthful diagnostics proof after carrying the FB-049 stale-canon blocker through Branch Readiness.
