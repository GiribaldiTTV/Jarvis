...
| `FAM-006` | Monitoring and HUD | High | Open / Recording Profile Runtime Foundation Workstream green after SLC-046 implementation/H1 green, SLC-047 selection/editing implementation/H1 green, SLC-048 relationship/boundary implementation/H1 green, SLC-049 Dashboard / Manage Monitors status integration implementation green, and SLC-050 Workstream readiness proof green; Overlay Display Acceptance Foundation released in `v1.7.19-prebeta` via PR #207 remains historical green | `PKG-006` Recording Profile Runtime Foundation SLC-046 through SLC-050 Workstream is complete and ready for Hardening H1; tray recording, recording execution, export/share, provider/model work, broad theme/skin work, FAM-007 work, PR creation, merge, release, issue mutation, artifacts/raw evidence handling, and sibling-worktree mutation remain USER-gated | `Docs/family_visions/FAM-006_monitoring_and_hud.md` | `Docs/branch_records/feature_fam_006_recording_profile_runtime_foundation.md` |
