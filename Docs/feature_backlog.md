...
PR Readiness: Historical PR #94 packaging is complete and merged. A follow-up blocker-clearing PR now carries repair commit `4a1d1e7689f5d2b9adcfeec5e390071fad4e3724` because `main` does not yet contain the repaired wait-timeout replacement-unconfirmed semantics or the non-Windows validator guard.
Release Target: v1.6.12-prebeta
Release Floor: patch prerelease
