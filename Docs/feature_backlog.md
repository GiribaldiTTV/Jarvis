...
| `FAM-006` | Monitoring and HUD | High | Open / Active Overlay Recording Runtime Implementation BP1 review reset | `PKG-006` active-overlay recording implementation carrier is admitted for setup; BP1 USER Branch Vision Review is active under the post-PR #248 two-axis gate model; BP2, BP3, Workstream Entry, and runtime recording implementation remain future-gated and USER-gated; released planning traceability remains preserved in `Docs/branch_records/feature_fam_006_active_overlay_recording_runtime_foundation.md` | `Docs/family_visions/FAM-006_monitoring_and_hud.md` | `Docs/branch_records/feature_fam_006_active_overlay_recording_runtime_implementation.md` |
...
Status: Open / Active Overlay Recording Runtime Implementation BP1 review reset
Record State: Registry-only
Registry Class: Feature Family
Family Anchor: Self
Priority: High
...
Package Summary: `PKG-006` active-overlay recording implementation carrier is admitted for Branch Readiness Stage 2 setup. Active-overlay-driven recording, HUD Overlay launcher/target preview, compact Recording Control window, Native Log Loader boundary, and per-overlay effective polling policy remain governed by the family vision and active branch plan; released planning traceability remains preserved in `Docs/branch_records/feature_fam_006_active_overlay_recording_runtime_foundation.md`, and runtime recording implementation remains future-gated until BP1, BP2, BP3, and USER implementation approval.
Package Admission State: Branch Readiness Stage 2 setup / BP1 USER Branch Vision Review active / runtime implementation pending BP2, BP3, and USER approval
