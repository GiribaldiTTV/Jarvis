...
| `FAM-006` | Monitoring and HUD | High | Open / Recording Profile Runtime Foundation Workstream rolled back by USER request; branch returned to Branch Readiness Stage 1 posture for corrected active-overlay-driven recording planning; Overlay Display Acceptance Foundation released in `v1.7.19-prebeta` via PR #207 remains historical green | `PKG-006` Recording Profile Runtime Foundation SLC-046 through SLC-050 route is withdrawn; future actual recording runtime must record active Overlay Profile membership with lightweight HUD Overlay Start/Stop and standalone Recording Settings after new Branch Readiness and Workstream approval; recording execution, output file writing, export/share, provider/model work, broad theme/skin work, FAM-007 work, PR creation, merge, release, issue mutation, artifacts/raw evidence handling, and sibling-worktree mutation remain USER-gated | `Docs/family_visions/FAM-006_monitoring_and_hud.md` | `Docs/branch_records/feature_fam_006_recording_profile_runtime_foundation.md` |
...
Status: Open / Recording Profile Runtime Foundation Workstream rolled back to Branch Readiness Stage 1 posture; active-overlay-driven recording vision is the next planning basis; Overlay Display Acceptance Foundation released in `v1.7.19-prebeta` via PR #207 remains historical green; released Dashboard, Sensor Command Center, and Overlay Profile Runtime Foundation evidence preserved
Record State: Registry-only
Registry Class: Feature Family
Family Anchor: Self
Priority: High
