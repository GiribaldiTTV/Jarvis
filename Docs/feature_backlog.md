...
| `FAM-007` | Local AI and Capability Packs | High | Open / package admitted; setup completion foundation released in v1.7.20-prebeta via PR #210 with PR #211 release-readiness fold-down evidence; AI Edition Public Leak-Prevention Foundation released in v1.7.22-prebeta via PR #215 with PR #216 release-readiness guard evidence; Dev/Owner Skeleton Readiness Foundation merged in PR #218 and is merged-unreleased current-main context until separate Release Readiness; Owner private repo and off-boot AI data backup/recovery remain explicit USER Action Gates; provider SDK/model execution and model work remain USER-gated | `PKG-007` admitted / not package-complete | `Docs/family_visions/FAM-007_local_ai_and_capability_packs.md` | `Docs/branch_records/feature_fam_007_ai_edition_dev_owner_skeleton_readiness_foundation.md` |
...
Status: Open / package admitted; consent collection implementation foundation is released in v1.7.16-prebeta via PR #201; durable consent persistence foundation is released in v1.7.17-prebeta via PR #203; user-operated consent UX foundation is released in v1.7.18-prebeta via PR #206; setup completion foundation is released in v1.7.20-prebeta via PR #210 with PR #211 release-readiness fold-down evidence; AI Edition Public Leak-Prevention Foundation is released in v1.7.22-prebeta via PR #215 with PR #216 release-readiness guard evidence; Dev/Owner Skeleton Readiness Foundation merged in PR #218 and is merged-unreleased current-main evidence with no-visible-runtime-surface waiver for Breakpoint 2 public-safe action-gate planning/proof; future private Dev/Owner skeleton implementation, off-boot AI data backup/recovery implementation, provider/model execution, and release execution remain USER-gated
Record State: Registry-only
Registry Class: Feature Family
Family Anchor: Self
Priority: High
