...
Next Legal Analysis Candidate: Workstream entry packet for the bounded FAM-007 Local AI Runtime Foundation. PR creation, merge, release work, provider SDK/model work, memory/indexing, voice/Core sync, shortcut/installer work, AI Product Contract import, Private Dev ORIN import, and GitHub issue creation remain separate USER decisions.
...
Status: Package admitted / PR #152 released in v1.7.2-prebeta / Branch Readiness Stage 2 active for next runtime foundation carrier
Record State: Registry-only
Registry Class: Feature Family
Family Anchor: Self
Priority: Medium
Next Workstream: FAM-007 Local AI Runtime Foundation
Next Workstream Carrier State: Active Branch Readiness Stage 2 carrier created from current origin/main
Recommended Next Workstream: Execute the bounded FAM-007 Local AI Runtime Foundation after Stage 2 validation and separate USER Workstream approval. The Workstream should advance the released local-only scaffold into a real local runtime foundation while keeping provider SDKs, model downloads, external calls, memory/indexing implementation, voice/Core runtime sync, shortcut/installer work, AI Product Contract import, issue work, PR creation, merge, and release work gated.
Minimal Scope: Branch Readiness Stage 2 records post-release canon closure for v1.7.2-prebeta, active branch authority, and a bounded same-branch Workstream plan for SLC-017, SLC-018, SLC-031, SLC-032, SLC-033, SLC-034, SLC-035, and SLC-036. Runtime implementation is not performed until separate USER Workstream approval.
Selected Next Implementation Branch: `feature/fam-007-local-ai-runtime-foundation`
...
Summary: Local AI and Capability Packs starts fresh as a broad family without reusing old `FB` numbering. PKG-007 remains admitted but not package-complete; PR #138 scaffold evidence is released in v1.7.1-prebeta, PR #152 local-only continuation is released in v1.7.2-prebeta, and `feature/fam-007-local-ai-runtime-foundation` is the current USER-approved Branch Readiness Stage 2 carrier for the next runtime foundation plan. No local model runtime, real provider SDK integration, memory/indexing implementation, voice/Core runtime sync, Dev ORIN, shortcut, installer, release, or capability-pack installation work is admitted without later USER-approved Workstream scope.
