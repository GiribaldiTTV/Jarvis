...
| `FAM-006` | Monitoring and HUD | High | Open / Active Overlay Recording Runtime Foundation planning-governance receipt released in `v1.7.25-prebeta` via PR #222 with PR #223 fold-down evidence; prior Recording Profile Runtime Foundation Workstream rolled back by USER request; Overlay Display Acceptance Foundation released in `v1.7.19-prebeta` via PR #207 remains historical green | `PKG-006` Active Overlay Recording Runtime Foundation is preserved as an accepted planning contract, not a runtime implementation package. Future recording must derive targets from active Overlay Profile membership, use the HUD Overlay card as launcher/target preview, use a compact standalone Recording Control window as the future control surface, keep Native Log Loader as a separate future graph/log viewer, and preserve per-overlay effective polling policy as future FAM-006 planning. SLC-051 through SLC-055, runtime implementation, recording execution, output file writing, real Start/Stop controls, tray controls, export/share, provider/model work, broad theme/skin work, FAM-007 work, release execution beyond already published v1.7.25-prebeta, issue mutation, artifacts/raw evidence handling beyond approved review bundles, old branch cleanup/deletion, and sibling-worktree mutation remain USER-gated. No runtime/user-facing release debt is created by this released planning-governance receipt. | `Docs/family_visions/FAM-006_monitoring_and_hud.md` | `Docs/branch_records/feature_fam_006_active_overlay_recording_runtime_foundation.md` |
| `FAM-007` | Local AI and Capability Packs | High | Open / package admitted; setup completion foundation released in v1.7.20-prebeta via PR #210 with PR #211 release-readiness fold-down evidence; AI Edition Public Leak-Prevention Foundation released in v1.7.22-prebeta via PR #215 with PR #216 release-readiness guard evidence; Dev/Owner Skeleton Readiness Foundation released in v1.7.23-prebeta via PR #218 with PR #217 USER branch plan review gate governance and PR #219 fold-down prevention evidence; Owner private repo and off-boot AI data backup/recovery remain explicit USER Action Gates; provider SDK/model execution and model work remain USER-gated | `PKG-007` admitted / not package-complete | `Docs/family_visions/FAM-007_local_ai_and_capability_packs.md` | `Docs/branch_records/feature_fam_007_ai_edition_dev_owner_skeleton_readiness_foundation.md` |
...
Status: Open / Active Overlay Recording Runtime Foundation planning-governance receipt released in `v1.7.25-prebeta` via PR #222 with PR #223 fold-down evidence; prior Recording Profile Runtime Foundation Workstream rolled back and preserved as historical rollback receipt; Overlay Display Acceptance Foundation released in `v1.7.19-prebeta` via PR #207 remains historical green; released Dashboard, Sensor Command Center, and Overlay Profile Runtime Foundation evidence preserved
Record State: Registry-only
Registry Class: Feature Family
Family Anchor: Self
Priority: High
...
Package Summary: `PKG-006` Active Overlay Recording Runtime Foundation is a released planning/governance receipt after USER rollback of the profile-loaded Recording Profile route. Future FAM-006 recording planning starts from active-overlay-driven recording and the active Overlay Profile membership target, with the HUD Overlay card as launcher/target preview, a compact standalone Recording Control window as future control surface, Native Log Loader as a separate future graph/log viewer, and per-overlay effective polling policy preserved as future planning. Overlay Display Acceptance Foundation is released `v1.7.19-prebeta` / PR #207 evidence; Active Overlay Recording Runtime Foundation planning is released `v1.7.25-prebeta` / PR #222 evidence with no runtime recording implementation shipped; detailed Monitor Groups, Sensor Library, Overlay Profile, returned USER UTS, interactive-control visual QA, right-edge resize rediscovery, visual proof, Warning Notifications, Provider Readiness, and Sensor Command Center history live in FAM-006 branch authority records and related workstream evidence.
Package Admission State: Planning preserved / runtime implementation deferred to a future USER-approved carrier
Admitted Slice Count: Historical planning receipt only; future package admission must occur on a later USER-approved carrier.
Package Completion State: Planning complete / runtime implementation not started and intentionally deferred; no runtime/user-facing release debt
Single-Slice Package User Approval: Not required - no active single-slice package is admitted; future package admission must have multiple concrete admitted slices or USER waiver.
Canonical Detail Owner: `Docs/branch_records/feature_fam_006_active_overlay_recording_runtime_foundation.md`
Family Vision Owner: `Docs/family_visions/FAM-006_monitoring_and_hud.md`
Historical Trace Coverage: `FB-040`, HUD surface gap, PR #118, PR #180, PR #194, PR #207, PR #212, PR #222, PR #223 fold-down evidence, `v1.7.25-prebeta` release evidence, and FAM-006 branch records. Historical Overlay Profile Runtime Foundation detail remains at `Docs/branch_records/feature_fam_006_overlay_profile_runtime_foundation.md`; historical Overlay Display Acceptance detail remains at `Docs/branch_records/feature_fam_006_overlay_display_acceptance_foundation.md`; historical Recording Profile rollback receipt remains at `Docs/branch_records/feature_fam_006_recording_profile_runtime_foundation.md`; active-overlay planning receipt remains at `Docs/branch_records/feature_fam_006_active_overlay_recording_runtime_foundation.md`.

### [ID: FAM-007] Local AI and Capability Packs

Status: Open / package admitted; consent collection implementation foundation is released in v1.7.16-prebeta via PR #201; durable consent persistence foundation is released in v1.7.17-prebeta via PR #203; user-operated consent UX foundation is released in v1.7.18-prebeta via PR #206; setup completion foundation is released in v1.7.20-prebeta via PR #210 with PR #211 release-readiness fold-down evidence; AI Edition Public Leak-Prevention Foundation is released in v1.7.22-prebeta via PR #215 with PR #216 release-readiness guard evidence; Dev/Owner Skeleton Readiness Foundation is released in v1.7.23-prebeta via PR #218 with PR #217 USER branch plan review gate governance and PR #219 fold-down prevention evidence; PR #220 is historical post-release canon-closure evidence only; future private Dev/Owner skeleton implementation, off-boot AI data backup/recovery implementation, provider/model execution, and release execution remain USER-gated
Record State: Registry-only
Registry Class: Feature Family
Family Anchor: Self
Priority: High
...
Minimal Scope: `runtime slice - USER-gated FAM-007 / PKG-007 private Dev and Nexus Desktop AI Owner skeleton continuation covering private root/repo action gates, off-boot AI data backup/recovery implementation planning, public-to-private separation, Public-to-Dev import gating, provider/model execution deferral, and future handoff criteria; branch creation is deferred to Branch Readiness after this PR and updated-main revalidation.`
Selected Next Implementation Branch: `Deferred to Branch Readiness`
Repair-Only Branch Handling: `feature/fam-007-v1-7-23-post-release-canon-closure is a historical repair-only branch after PR #220 merge and does not imply Branch Readiness admission or active branch truth.`
Selection Truth Status: `USER-approved during PR Readiness Stage 1 repair/sync for feature/fam-007-ai-edition-dev-owner-skeleton-readiness-foundation; no next branch is created by this selection truth.`
Historical Branch Runtime Engineering Plans: `Docs/branch_plans/feature_fam_007_local_ai_provider_setup_implementation_foundation.md`; `Docs/branch_plans/feature_fam_007_local_ai_provider_consent_collection_foundation.md`; `Docs/branch_plans/feature_fam_007_local_ai_provider_consent_collection_implementation_foundation.md`; `Docs/branch_plans/feature_fam_007_local_ai_provider_durable_consent_persistence_foundation.md`; `Docs/branch_plans/feature_fam_007_local_ai_provider_user_operated_consent_ux_foundation.md`; `Docs/branch_plans/feature_fam_007_local_ai_provider_setup_completion_foundation.md`
Historical Trace Coverage: FAM-007 branch records, PR #138, PR #152, PR #159, PR #162, PR #165, PR #170, PR #172, PR #177, PR #179, PR #190, PR #192, PR #193, released PR #201 posture for `feature/fam-007-local-ai-provider-consent-collection-implementation-foundation`, released PR #203 posture for `feature/fam-007-local-ai-provider-durable-consent-persistence-foundation`, released PR #206 posture for `feature/fam-007-local-ai-provider-user-operated-consent-ux-foundation`, released PR #210 posture for `feature/fam-007-local-ai-provider-setup-completion-foundation`, released PR #215 posture for `feature/fam-007-ai-edition-public-leak-prevention-foundation`, released v1.7.23-prebeta PR #218 posture for `feature/fam-007-ai-edition-dev-owner-skeleton-readiness-foundation`, and PR #220 historical post-release canon-closure posture for `feature/fam-007-v1-7-23-post-release-canon-closure`.
