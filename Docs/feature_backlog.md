...
| `FAM-006` | Monitoring and HUD | High | Open / Recording Profile Runtime Foundation Live Validation LV1 green after SLC-046 implementation/H1 green, SLC-047 selection/editing implementation/H1 green, SLC-048 relationship/boundary implementation/H1 green, SLC-049 Dashboard / Manage Monitors status integration implementation/package H1 green, SLC-050 Workstream readiness proof/package H1 green, and bounded LV1 real-input desktop proof; Overlay Display Acceptance Foundation released in `v1.7.19-prebeta` via PR #207 remains historical green | `PKG-006` Recording Profile Runtime Foundation SLC-046 through SLC-050 Workstream, H1, and LV1 are complete and ready for PR Readiness Stage 1 analysis; tray recording, recording execution, export/share, provider/model work, broad theme/skin work, FAM-007 work, PR creation, merge, release, issue mutation, artifacts/raw evidence handling beyond approved LV1 proof, and sibling-worktree mutation remain USER-gated | `Docs/family_visions/FAM-006_monitoring_and_hud.md` | `Docs/branch_records/feature_fam_006_recording_profile_runtime_foundation.md` |
