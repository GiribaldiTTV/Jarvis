...
Released Historical Scope: FAM-006 Monitoring HUD Dashboard Product Surface released in v1.7.0-prebeta through PR #118; FAM-006 Dashboard render/layout hardening PR #129, Dashboard IA/control follow-through PR #132, Dashboard settings-panel runtime PR #142, and FAM-007 PR #138 provider-boundary / no-provider shell scaffold support released in v1.7.1-prebeta; FAM-007 PR #152 local AI foundation continuation plus governance/readiness support PRs #148, #149, #150, #151, #153, and #154 released in v1.7.2-prebeta; PR #155, PR #156, PR #157, PR #158, PR #159, PR #160, and PR #161 released in v1.7.3-prebeta; FAM-007 PR #162 local AI runtime contracts and capability foundation is merged-unreleased release-window scope; FAM-001 legacy FB-049 Active-session pre-settled incoming-launch conflict truth, FAM-004 legacy FB-030 voice/audio runtime diagnostics proof, merged governance/automation proof package, PR #112 source-truth closeout / merge-target authority hardening proof, and PR #113 source-truth closeout / merge-target authority hardening proof released in v1.6.13-prebeta.
Repo State: Branch-local FAM-006 Monitor Groups / Sensor Command Center reconciliation on `feature/fam-006-monitor-groups-sensor-configuration` in `C:\Nexus Worktrees\FAM-006`; PR #163 / `origin/main` no-active-main and FAM-007 merged-unreleased truth is preserved as context, not identity.
Merged-Main Repo State Before Branch: No Active Branch after v1.7.3-prebeta release publication; PR #162 later merged the USER-approved FAM-007 runtime carrier into `origin/main` as merged-unreleased release-window scope, while this branch remains the USER-approved FAM-006 runtime carrier.
...
Published Release Pending Canon Closure: None - v1.7.3-prebeta source truth is closed, and PR #162 is separate merged-unreleased FAM-007 release-window scope.
Closure Repair Surface: Standing Governance intake RRI-20260518-001 for post-PR #162 source-truth drift only.
...
Release-Debt Avoidance Status: PR #162 is merged-unreleased FAM-007 release-window scope; release execution remains USER-gated and future FAM-007 runtime expansion, provider/model/memory/shortcut/installer work, Overlay acceptance, AI Product work, and issue work remain separate USER-gated decisions.
Merged-main Current Active Workstream: None - origin/main is no-active-branch runtime truth after PR #162.
Current Active Workstream: Branch-local FAM-006 Monitor Groups / Sensor Command Center repair lane on `feature/fam-006-monitor-groups-sensor-configuration`; PR Readiness remains blocked pending repair planning/setup for the returned USER blockers.
Branch-Local FAM-006 Reconciliation Note: `feature/fam-006-monitor-groups-sensor-configuration` in `C:\Nexus Worktrees\FAM-006` treats `origin/main` PR #163 as context, not identity. The branch-local authority remains FAM-006 Monitor Groups / Sensor Command Center. Pending repair blockers are first-launch Dashboard flicker regression; Source Filter as Nexus-styled dropdown rather than exposed chips; dropdown open/hover reset so prior hover does not remain highlighted; 20+ monitor-group left-list stress proof with NDAI scrollbar styling; lower-right/bottom Delete Selected Monitor and bottom confirmation placement; reduced top toolbar/search/create headspace; taller default and somewhat resizable Manage Monitors window; copy cleanup for phrases such as "for this monitor group"; preservation of prior visible resize-proof contamination repair; preservation of invisible/test-gated grow/shrink proof; Sensor Library source discovery; Warning Notifications as a setting checkbox; Provider Readiness as readiness/status/future capability; and preservation of Sensor Library / Monitor / Monitor Group / Overlay Profile / Recording Profile separation.
...
Selected Next Record State: Branch-local repair setup after current-main reconciliation; PR #163 no-active-main truth is context only.
...
Selected Next Status: FAM-006 PR Readiness is blocked pending Branch Readiness repair setup and later USER-approved runtime repair implementation.
...
Next Legal Runtime Step: Repair Workstream implementation after this Branch Readiness repair setup validates and USER approves the implementation scope.
...
Post-Release Truth: `v1.7.3-prebeta` is the latest public prerelease; PR #155 through PR #161 are released historical scope; PR #162 is merged-unreleased release-window scope; no active main branch authority is implied by the release.
...
Next Legal Phase: Release Readiness Stage 1 from updated `origin/main` after the standing Governance post-PR #162 closure repair merges and returns the FAM-007 rebaseline digest; release execution, issue work, provider SDK/model work, memory/indexing implementation, voice/Core runtime sync, shortcut/installer work, and AI Product Contract import remain separate USER decisions.
...
Selected Next Workstream: FAM-006 Monitor Groups / Sensor Command Center returned USER UTS FAIL repair planning/setup.
Selected Next Runtime Package Candidate: PKG-006 continuation for Monitor Groups / Sensor Command Center only.
Selected Next Status: Branch-local current-main reconciliation preserves PR #163 main truth, keeps PR Readiness blocked, and routes newly returned FAM-006 blockers to Branch Readiness repair setup before runtime implementation resumes.
Selected Next Implementation Branch: `feature/fam-006-monitor-groups-sensor-configuration`
...
Active Branch Authority Record: `Docs/branch_records/feature_fam_006_monitor_groups_sensor_configuration.md`
Next Legal Runtime Step: Repair Workstream implementation for returned FAM-006 Monitor Groups / Sensor Command Center blockers after this Branch Readiness repair setup validates green and USER approves implementation. PR creation, merge, release work, FAM-007/local AI work, and GitHub issue mutation require separate explicit USER approval.
