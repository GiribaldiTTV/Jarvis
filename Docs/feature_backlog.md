...
| `FAM-006` | Monitoring and HUD | High | Open / Active Overlay Recording Runtime Foundation planning-governance closeout; PR Readiness Stage 1 pending; prior Recording Profile Runtime Foundation Workstream rolled back by USER request; Overlay Display Acceptance Foundation released in `v1.7.19-prebeta` via PR #207 remains historical green | `PKG-006` Active Overlay Recording Runtime Foundation is preserved as an accepted planning contract, not a runtime implementation package on this branch. Future recording must derive targets from active Overlay Profile membership, use the HUD Overlay card as launcher/target preview, use a compact standalone Recording Control window as the future control surface, keep Native Log Loader as a separate future graph/log viewer, and preserve per-overlay effective polling policy as future FAM-006 planning. SLC-051 through SLC-055, runtime implementation, recording execution, output file writing, real Start/Stop controls, tray controls, export/share, provider/model work, broad theme/skin work, FAM-007 work, PR creation, merge, release, issue mutation, artifacts/raw evidence handling beyond approved review bundles, old branch cleanup/deletion, and sibling-worktree mutation remain USER-gated. No runtime/user-facing release debt is created by this planning-governance branch. | `Docs/family_visions/FAM-006_monitoring_and_hud.md` | `Docs/branch_records/feature_fam_006_active_overlay_recording_runtime_foundation.md` |
...
Historical Trace Coverage: `FB-040`, HUD surface gap, PR #118, PR #180, PR #194, PR #207, PR #212, FAM-006 branch records. Historical Overlay Profile Runtime Foundation detail remains at `Docs/branch_records/feature_fam_006_overlay_profile_runtime_foundation.md`; historical Overlay Display Acceptance detail remains at `Docs/branch_records/feature_fam_006_overlay_display_acceptance_foundation.md`; historical Recording Profile rollback receipt remains at `Docs/branch_records/feature_fam_006_recording_profile_runtime_foundation.md`.
