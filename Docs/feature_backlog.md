...
| `FAM-006` | Monitoring and HUD | High | Open / Recording Profile Runtime Foundation active in Branch Readiness Stage 2 setup; Overlay Display Acceptance Foundation released in `v1.7.19-prebeta` via PR #207 remains historical green | `PKG-006` Recording Profile Runtime Foundation planning admitted / runtime implementation pending Workstream Entry | `Docs/family_visions/FAM-006_monitoring_and_hud.md` | `Docs/branch_records/feature_fam_006_recording_profile_runtime_foundation.md` |
