...
| `FAM-006` | Monitoring and HUD | High | Open / Active Overlay Recording Runtime Implementation H1 Green | `PKG-006` active-overlay recording implementation carrier is Workstream Green and Hardening H1 Green; BP1/BP2 are accepted, BP3 is USER Approved, SLC-051 target/session truth is implemented, SLC-052 HUD Overlay target preview is implemented, SLC-053 standalone Recording Control window foundation is implemented, SLC-054 durable output contract schema/readback proof is implemented, SLC-055 validation/live proof readiness is implemented, LV1 is pending, and runtime recording implementation remains future-gated; released planning traceability remains preserved in `Docs/branch_records/feature_fam_006_active_overlay_recording_runtime_foundation.md` | `Docs/family_visions/FAM-006_monitoring_and_hud.md` | `Docs/branch_records/feature_fam_006_active_overlay_recording_runtime_implementation.md` |
...
Status: Open / Active Overlay Recording Runtime Implementation H1 Green
Record State: Registry-only
Registry Class: Feature Family
Family Anchor: Self
Priority: High
