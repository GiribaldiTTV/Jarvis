...
| `SLC-041` | `PKG-006` | `FAM-006` | Overlay Profile validation and live desktop proof | Admitted | Workstream + H1 Green | Focused validator/live-proof readiness implemented and H1 Green / LV1 next | `feature/fam-006-overlay-profile-runtime-foundation`; plan-owned seam 5 |
