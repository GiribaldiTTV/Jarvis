...
Release Execution State: `v1.7.7-prebeta` is published at `eb8d36b4464ad560a59cfea8ddc641aa6374293f`; current main closes the release-dependent canon drift in source truth, while this FAM-006 branch preserves that as context.
