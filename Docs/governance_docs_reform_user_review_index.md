...
| `Docs/branch_plans/feature_fam_007_local_ai_provider_setup_completion_foundation.md` | High | `volatile-current-wording=97`; `unclear-ownership-wording=97`; `soft-commitment-wording=3`; `state-ledger-wording=157` | Clarify owner, time basis, and whether wording is historical receipt or live truth. |
