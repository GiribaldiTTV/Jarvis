...
| --- | --- | --- | --- |
| `Docs/Main.md` | High | `volatile-current-wording=347`; `unclear-ownership-wording=156`; `soft-commitment-wording=59`; `state-ledger-wording=215` | Clarify owner, time basis, and whether wording is historical receipt or live truth. |
