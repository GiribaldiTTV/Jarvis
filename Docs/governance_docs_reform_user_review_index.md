...
| `Docs/branch_plans/feature_fam_006_overlay_display_acceptance_foundation.md` | High | `volatile-current-wording=166`; `unclear-ownership-wording=79`; `soft-commitment-wording=25`; `state-ledger-wording=135` | Clarify owner, time basis, and whether wording is historical receipt or live truth. |
...
| `Docs/branch_plans/feature_fam_007_local_ai_provider_setup_completion_foundation.md` | High | `volatile-current-wording=81`; `unclear-ownership-wording=95`; `soft-commitment-wording=3`; `state-ledger-wording=164` | Clarify owner, time basis, and whether wording is historical receipt or live truth. |
