...
4. Review `Complete Docs Cleanup / Disposition Table` for every file's keep/compact/migrate/retire/delete posture.
...
- [ ] Structure risks have a migration, compaction, or keep-now decision.
