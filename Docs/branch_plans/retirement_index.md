...
| `Docs/branch_plans/feature_fam_007_local_ai_provider_setup_completion_foundation.md` | Retired from active planning posture after PR #210 merge; preserved as merged-unreleased v1.7.20-prebeta release-window planning receipt | `Docs/branch_records/feature_fam_007_local_ai_provider_setup_completion_foundation.md`; `Docs/family_visions/FAM-007_local_ai_and_capability_packs.md`; `Docs/family_visions/FAM-007_ai_edition_capability_trust_boundary_release_plan.md` |
