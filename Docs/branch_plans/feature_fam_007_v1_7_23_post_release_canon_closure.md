...
Historical USER Decision Receipt: `None for this merged historical carrier; rerun Release Readiness from current origin/main through the legal release carrier when validation is green.`
