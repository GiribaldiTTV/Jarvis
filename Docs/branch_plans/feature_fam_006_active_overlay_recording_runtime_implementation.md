...
Current-Main Reconciliation Status: `Waiting For Updated Main - reconciliation to origin/main@acd6bc24bb6e4c2e077826e94b8335caed0d8b17 is blocked by incoming FAM-007 source-truth validation debt owned by the FAM-007 lane. FAM-006 must not mutate FAM-007 source truth; Workstream Entry and review-bundle regeneration wait until the FAM-007 lane repairs/folds down its source truth and FAM-006 can reconcile green.`
...
Current-Main / Review-Bundle Blocker: FAM-006 Stage 2 review-bundle regeneration is intentionally paused while current-main reconciliation is blocked by incoming FAM-007 source-truth validation debt. Stable Desktop review paths may remain absent until FAM-007-owned debt is repaired outside this branch and FAM-006 reconciliation validates green.
...
Workstream Entry Result: Blocked pending updated main - Workstream Entry analysis must wait until FAM-007-owned current-main source-truth validation debt is repaired outside this branch, FAM-006 current-main reconciliation validates green, and the Stage 2 USER review packet is regenerated from clean stable paths. No recording execution, file writing, real Start/Stop behavior, HUD recording controls, Recording Control window, or output-file behavior is admitted by Stage 2.
...
Exact USER Decision Needed: `FAM-006 waits for the FAM-007 lane to repair/fold down incoming FAM-007 source-truth validation debt on origin/main. After origin/main is validation-green for FAM-006 reconciliation, USER may approve FAM-006 current-main reconciliation and Stage 2 review-bundle regeneration. Workstream Entry remains blocked until that reconciliation and packet refresh are green.`
