...
- local USER hub packet at `C:\Nexus USER\<worktree-label>` with matching stable ZIP at `C:\Nexus USER\<worktree-label>.zip` and timestamped USER upload ZIP at `C:\Nexus USER\<worktree-label>__YYYYMMDD-HHMMSS.zip` when USER review is required
